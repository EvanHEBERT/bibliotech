export const INITIAL_LIBRARY_DATA = [
  ...
  },
  {
    ...
    subTypes: [
      {
        id: "hum-interne",
        name: "Humidificateurs Internes (dépendants)",
        models: [
          {
            id: "dreamstation-hum",
            name: "DreamStation",
            failures: [
                ...
                { title: "Bruit anormal ou vibrations", causes: ["Réglage humidité trop élevé (glouglou)", "Température de chambre basse", "Tuyau non isolé", "Appareil trop haut"], solutionsPatient: ["Baissez le réglage d'un niveau", "Placez la machine plus bas que la tête", "Utiliser une housse de tuyau"], solutionsTech: ["Conseiller un tuyau chauffant (HT15)", "Vérifier la sonde de température", "Passer en mode Adaptatif"] }
            ]
          },
          {
            id: "h41",
            name: "H41",
            failures: [
                { title: "Humidification (Air sec ou condensation)", causes: ["Plaque chauffante HS", "Option désactivée dans le menu", "Bac entartré", "Mauvais couplage bac/machine", "Température ambiante trop basse"], solutionsPatient: ["Vérifier l'activation dans le menu patient", "Enfoncer le bac fermement jusqu'au clic", "Détartrer le bac au vinaigre blanc", "Ajuster le réglage de chauffe", "Utiliser une housse de tuyau"], solutionsTech: ["Tester la résistance de la plaque", "Vérifier le fusible thermique interne", "Remplacer l'embase chauffante", "Contrôler la sonde de température"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Joint de bac usé ou mal positionné", "Réservoir fissuré (choc)", "Niveau d'eau dépassant le trait MAX"], solutionsPatient: ["Vérifier que le joint est propre et bien logé", "Insérer le bac fermement jusqu'au clic", "Essuyer sous l'appareil pour localiser la fuite", "Changer le réservoir si fissuré"], solutionsTech: ["Remplacer le joint d'étanchéité", "Changer le réservoir complet", "Vérifier l'étanchéité des ports"] },
                { title: "Bruit anormal ou vibrations", causes: ["Réservoir mal enclenché", "Condensation dans le tuyau (glouglou)", "Joint d'embase desséché"], solutionsPatient: ["Vérifier que le réservoir est bien enfoncé jusqu'au clic", "Vider l'eau du tuyau", "Placer l'appareil sur une surface plane"], solutionsTech: ["Vérifier l'état du joint d'embase", "Inspecter les fixations de la plaque chauffante", "Lubrifier légèrement le joint"] },
                { title: "Erreur Système (Chauffage / Capteurs)", causes: ["Résistance chauffante HS", "Capteur d'humidité défectueux", "Contacts embase oxydés"], solutionsPatient: ["Nettoyer les contacts métalliques (chiffon sec)", "Débrancher/rebrancher l'appareil", "Vérifier si un message s'affiche sur la PPC"], solutionsTech: ["Mesurer Ohms résistance", "Vérifier tension embase", "Remplacer sonde ou plaque"] }
            ]
          },
          {
            id: "hum-breas",
      ...
      {
        id: "hum-externe",
        name: "Humidificateurs Externes (autonomes)",
        models: [
          {
            id: "hc150",
            name: "HC150",
  ...
  },
  {
    ...
    subTypes: [
      {
        id: "bouteille-o2",
        name: "Bouteilles d'Oxygène",
        models: [
          {
            id: "b15",
            name: "Bouteille B15",
            failures: [
                { title: "Débit faible ou irrégulier", causes: ["Bouteille vide", "Robinet mal ouvert", "Canule pliée"], solutionsPatient: ["Vérifier zone verte mano", "Ouvrir robinet à fond"], solutionsTech: ["Tester autre manodétendeur"] },
                { title: "Fuites importantes", causes: ["Joint O-ring manquant", "Sifflement"], solutionsPatient: ["Vérifier joint au raccord", "Serrer détendeur"], solutionsTech: ["Changer joint O-ring"] },
                { title: "Manomètre défectueux", causes: ["Choc", "Aiguille bloquée"], solutionsPatient: ["L'aiguille bouge-t-elle à l'ouverture ?"], solutionsTech: ["Remplacer le manomètre"] }
            ]
          },
          {
            id: "b2",
            name: "Bouteille B2",
            failures: [
                { title: "Débit faible ou irrégulier", causes: ["Bouteille vide"], solutionsPatient: ["Check mano"], solutionsTech: ["Check débitmètre"] },
                { title: "Fuites importantes", causes: ["Joint"], solutionsPatient: ["Sifflement"], solutionsTech: ["Changer joint"] },
                { title: "Manomètre défectueux", causes: ["Choc"], solutionsPatient: ["Aiguille bloquée"], solutionsTech: ["Remplacer"] }
            ]
          },
          {
            id: "b5",
            ...
            models: [
              {
                ...
                name: "10L (GCE / 1025KS)",
                failures: [
                  { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Alimentation", "Cordon", "Interrupteur"], solutionsPatient: ["Vérifier le branchement aux deux extrémités", "Tester une autre prise murale", "Vérifier le disjoncteur du domicile"], solutionsTech: ["Vérifier le cordon secteur.", "Vérifier le fusible/disjoncteur.", "Vérifier l'interrupteur."] },
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Tamis moléculaire usé", "Mauvaise concentration O₂", "Filtre colmaté", "Fuite interne"], solutionsPatient: ["Vérifier que l'appareil est loin des murs (> 15cm)", "Nettoyer le filtre à poussière", "Aérer la pièce"], solutionsTech: ["Mesurer la pureté à l'analyseur.", "Vérifier l'étanchéité pneumatique.", "Remplacer les colonnes."] },
                  { title: "Erreur Système (Surchauffe / Ventilation / Disjoncteur)", causes: ["Disjoncteur thermique (surcharge)", "Surchauffe compresseur", "Câble secteur endommagé", "Panne ventilateur", "Ventilation obstruée", "Environnement trop chaud"], solutionsPatient: ["Appuyez sur le bouton blanc du disjoncteur (Reset)", "Vérifiez si le cordon est abîmé ou chaud", "Laissez refroidir l'appareil 30 minutes", "Nettoyer les grilles d’aération", "Dégager l'espace autour de l'appareil", "Fait-il très chaud dans la pièce ?"], solutionsTech: ["Contrôle température turbine", "Vérifier la consommation électrique du compresseur", "Remplacer le ventilateur interne", "Nettoyer grilles d’aération.", "Déplacer appareil, laisser refroidir."] },
                  { title: "Erreur Système (Circuit Bouché)", causes: ["Canule pliée", "Filtre HEPA colmaté", "Humidificateur obstrué"], solutionsPatient: ["Vérifier si le tuyau est coincé", "Vérifier le serrage du bocal d'eau"], solutionsTech: ["Remplacer le filtre HEPA", "Ajuster le débitmètre"] },
                  { title: "Bruit anormal ou vibrations", causes: ["Silentblocs usés", "Compresseur fatigué", "Position instable"], solutionsPatient: ["Vérifier que l'appareil est bien à plat", "Vérifier qu'aucun objet ne touche la coque"], solutionsTech: ["Remplacer les silentblocs", "Maintenance compresseur"] }
                ]
              },
              {
                id: "525ks",
                ...
                failures: [
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Tamis moléculaire usé", "Mauvaise concentration O₂", "Vanne 4 voies bloquée", "Fuite interne"], solutionsPatient: ["Le voyant O2 est-il allumé ?", "L'appareil a-t-il été entretenu récemment ?", "La pièce est-elle bien aérée ?"], solutionsTech: ["Vérifier pureté.", "Maintenance interne.", "Contrôler la vanne 4 voies."] },
                  { title: "Erreur Système (Défaut Pression / Fuite interne)", causes: ["Fuite interne sur les tubulures", "Vanne 4 voies bloquée"], solutionsPatient: ["Sentez-vous moins d'air sortir ?", "Entendez-vous un sifflement ?"], solutionsTech: ["Recherche de fuite.", "Test étanchéité interne."] },
              ...
              },
              {
                ...
                failures: [
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Tamis moléculaire usé", "Mauvaise concentration O₂", "Humidité excessive", "Compresseur sous-performant", "Fuite interne"], solutionsPatient: ["Le voyant O2 est-il allumé ?", "L'appareil a-t-il été entretenu récemment ?", "La pièce est-elle bien aérée ?", "L'appareil est-il utilisé près d'une source de vapeur ?"], solutionsTech: ["Vérifier la pureté à l'analyseur.", "Maintenance interne filtres.", "Remplacer les colonnes.", "Contrôler les pressions."] },
                  { title: "Erreur Système (Défaut Pression / Fuite interne)", causes: ["Fuite tubulure", "Vanne 4 voies bloquée"], solutionsPatient: ["Bruit de sifflement ?", "Baisse de débit ?"], solutionsTech: ["Localiser la fuite.", "Vérifier cycle vanne."] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                ]
              },
              {
              ...
              },
              {
                ...
                failures: [
                  { title: "Débit faible ou irrégulier", causes: ["Débitmètre réglé à moins de 1 L/min", "Tubulure de 15 m pliée", "Filtre HEPA interne colmaté", "Fuite bocal humidificateur"], solutionsPatient: ["Augmentez le débit au-dessus de 1 L/min pour tester.", "Redressez la tubulure pour éviter les coudes.", "Vérifier le serrage du bocal d'eau."], solutionsTech: ["Vérifier l'étanchéité du circuit interne.", "Tester la pression de sortie du compresseur.", "Remplacer le filtre HEPA interne."] },
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Saturation des tamis", "Filtre d'entrée colmaté", "Fuite interne"], solutionsPatient: ["Le voyant jaune est-il allumé ?", "L'appareil est-il loin des murs ?"], solutionsTech: ["Mesurer la pureté O2.", "Remplacer les colonnes de tamis.", "Vérifier l'étanchéité pneumatique."] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                ]
              },
              {
                ...
                failures: [
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Usure des tamis moléculaires", "Filtre d'entrée poussiéreux", "Fuite interne"], solutionsPatient: ["Est-ce que vous voyez un voyant de couleur jaune ou rouge allumé ?", "Le filtre noir on le côté de l'appareil vous semble-t-il propre ?"], solutionsTech: ["Mesurer la pureté à l'analyseur.", "Effectuer un test de fuite.", "Remplacer les colonnes de tamis."] },
              ...
              },
              {
                ...
                failures: [
                  { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté", "Fusible interne grillé", "Surchauffe"], solutionsPatient: ["La prise est-elle bien branchée ?", "L'appareil est-il chaud ?", "Vérifiez l'interrupteur Marche/Arrêt."], solutionsTech: ["Vérifier le fusible.", "Tester la tension sur la carte."] },
                  ...
                  { title: "Erreur Système (Bouteille mal enclenchée)", causes: ["Bouteille mal positionnée", "Joint de l'embase sale", "Compresseur interne fatigué"], solutionsPatient: ["Retirez et remettez la bouteille jusqu'au 'double clic'.", "Nettoyez le connecteur avec un chiffon propre et sec."], solutionsTech: ["Remplacer le joint de l'embase.", "Vérifier le débit de remplissage."] },
                  ...
                  { title: "Problème de remplissage lent", causes: ["Compresseur fatigué", "Fuite interne", "Bouteille en fin de vie"], solutionsPatient: ["Vérifiez que la bouteille ne siffle pas.", "Nettoyez le raccord de la bouteille."], solutionsTech: ["Mesurer le débit de remplissage.", "Tester avec une bouteille neuve."] },
          ...
          },
          {
            ...
            models: [
              ...
              },
              {
                ...
                name: "Inogen Rove 6",
                failures: [
                  { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Batterie vide", "Chargeur déconnecté", "Prise murale défectueuse"], solutionsPatient: ["La prise est-elle bien enfoncée ?", "L'appareil démarre-t-il sans batterie sur secteur ?"], solutionsTech: ["Tester l'alimentation externe.", "Vérifier le connecteur de charge."] },
                  { title: "Problème de batterie ou autonomie", causes: ["Batterie en fin de vie", "Contacts sales", "Surchauffe batterie"], solutionsPatient: ["Avez-vous entendu le 'clic' ?", "La batterie est-elle très chaude ?", "Nettoyez les contacts avec un chiffon sec."], solutionsTech: ["Contrôler la capacité.", "Remplacer la batterie."] },
                  { title: "Problème d'alimentation (12V / Voiture)", causes: ["Cordon DC mal inséré", "Fusible allume-cigare grillé", "Prise voiture défectueuse"], solutionsPatient: ["Vérifiez que la prise est bien enfoncée dans l'allume-cigare.", "Vérifiez le voyant sur la prise.", "Dévissez l'embout pour vérifier le petit fusible."], solutionsTech: ["Tester la continuité du câble DC.", "Vérifier le fusible du câble."] },
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Tamis (colonnes) usés", "Filtres à particules sales", "Fuite interne"], solutionsPatient: ["Les filtres sur les côtés sont-ils propres ?", "L'appareil est-il bien aéré dans son sac ?"], solutionsTech: ["Mesurer la pureté O2.", "Remplacer les colonnes.", "Vérifier l'étanchéité pneumatique."] },
                  { title: "Débit faible ou irrégulier", causes: ["Canule pliée ou écrasée", "Filtre d'entrée colmaté", "Fuite interne"], solutionsPatient: ["Vérifiez que votre canule n'est pas pliée.", "Essayez avec une canule neuve.", "Sentez-vous l'air sortir au bout ?"], solutionsTech: ["Vérifier le capteur de débit.", "Remplacer les filtres internes."] },
                  { title: "Erreur Système (Surchauffe / Ventilation)", causes: ["Ventilation obstruée", "Température ambiante trop élevée", "Ventilateur interne bloqué"], solutionsPatient: ["L'appareil est-il très chaud ?", "Vérifiez que rien ne bouche les grilles d'aération.", "Sortez l'appareil de sa sacoche."], solutionsTech: ["Nettoyer les ouïes de ventilation.", "Vérifier le fonctionnement du ventilateur."] },
                  { title: "Problème de détection respiratoire (Trigger)", causes: ["Respiration par la bouche", "Canule trop longue (> 2.1m)", "Sensibilité trigger basse"], solutionsPatient: ["Respirez bien par le nez.", "Utilisez une canule de 2 mètres maximum.", "Vérifiez le branchement du tuyau."], solutionsTech: ["Recalibrer la sensibilité du trigger.", "Tester la valve pneumatique."] },
                  { title: "Erreur Système (Codes Alarme / SAV)", causes: ["Alert 01 (O2)", "Alert 02 (Pression)", "Alert 04 (Batterie)", "Panne interne"], solutionsPatient: ["Retirez la batterie et débranchez le secteur 1 minute.", "Redémarrez l'appareil.", "Notez le numéro de code qui s'affiche."], solutionsTech: ["Identifier le composant via le code erreur.", "Tester les tensions de carte."] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                ]
              },
              {
                ...
                failures: [
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Saturation des tamis", "Filtres encrassés", "Fuite interne"], solutionsPatient: ["Nettoyez les filtres d'entrée d'air.", "Assurez-vous que l'appareil n'est pas dans un sac fermé."], solutionsTech: ["Mesurer la pureté.", "Remplacer les colonnes.", "Vérifier l'étanchéité pneumatique."] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                ]
              },
          ...
          },
          {
            ...
            models: [
              ...
              },
              {
                ...
                name: "Eclipse 5",
                failures: [
                  { title: "Alimentation (Secteur / 12V)", causes: ["Batterie vide", "Chargeur HS", "Cordon 12V mal inséré", "Connectique interne défaillante", "Carte mère HS"], solutionsPatient: ["Brancher sur secteur", "Le voyant du bloc est-il allumé ?", "Vérifier branchement allume-cigare", "Retirer la batterie pour tester sur secteur seul"], solutionsTech: ["Tester la tension du chargeur (28V DC)", "Vérifier l'embase de charge", "Contrôler le fusible du câble DC", "Remplacer la carte mère"] },
                  { title: "Batterie ou Autonomie", causes: ["Batterie en fin de vie", "Surchauffe batterie", "Défaut de communication batterie", "Contacts sales"], solutionsPatient: ["Brancher sur secteur immédiatement", "Retirez et remettez la batterie fermement", "Laissez la batterie refroidir", "Nettoyer les contacts métalliques"], solutionsTech: ["Vérifier la capacité de charge", "Nettoyer les connecteurs machine", "Remplacer la batterie", "Vérifier le circuit de charge"] },
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Saturation des tamis moléculaires", "Filtre d'entrée colmaté", "Fuite interne", "Humidité excessive"], solutionsPatient: ["Vérifier le filtre à poussière", "Placer dans un endroit bien aéré", "Éloigner de toute source de vapeur", "Aérez la pièce"], solutionsTech: ["Mesurer la pureté O2", "Remplacer les colonnes de tamis", "Vérifier la pression du compresseur", "Contrôler l'étanchéité pneumatique"] },
                  { title: "Débit faible ou irrégulier", causes: ["Canule pliée ou écrasée", "Filtre HEPA bouché", "Vanne de sortie bloquée", "Humidificateur fuyard"], solutionsPatient: ["Vérifier si la canule est pliée", "Essayer une canule neuve", "Sentez-vous l'air sortir au bout ?", "Serrer l'humidificateur"], solutionsTech: ["Vérifier le capteur de débit", "Remplacer le filtre HEPA", "Tester la pression de sortie", "Vérifier la vanne de pulsion"] },
                  { title: "Erreur Système (Surchauffe / Ventilation)", causes: ["Ventilation obstruée", "Ventilateur interne HS", "Environnement trop chaud", "Filtres internes encrassés"], solutionsPatient: ["Sortir l'appareil de sa sacoche", "Vérifier que les grilles sont libres", "Laissez refroidir l'appareil 30 minutes", "Éloigner l'appareil du soleil"], solutionsTech: ["Vérifier le ventilateur interne", "Nettoyage interne à l'air sec", "Contrôler la température de la turbine"] },
                  { title: "Détection respiratoire (Trigger)", causes: ["Respiration par la bouche", "Canule trop longue (> 2m)", "Sensibilité trigger basse", "Valve de pulsion bloquée"], solutionsPatient: ["Respirez bien par le nez", "Utilisez une canule de 2 mètres maximum", "Vérifiez le branchement du tuyau", "Testez en mode continu"], solutionsTech: ["Recalibrer la sensibilité du trigger", "Tester la valve pneumatique", "Vérifier l'étanchéité du circuit"] },
                  { title: "Erreur Système (Code Fail / Alarmes)", causes: ["Code Fail 01, 02, 04...", "Défaut carte mère", "Bug logiciel"], solutionsPatient: ["Retirez la batterie et le secteur 1 minute", "Redémarrez l'appareil", "Notez le numéro de Fail qui s'affiche"], solutionsTech: ["Identifier le composant via le code erreur", "Tester les tensions de carte", "Mise à jour firmware"] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier"], solutionsTech: ["Vérifier les fixations moteur", "Remplacer les silentblocs", "Vérifier le ventilateur", "Resserrer le châssis"] },
  ...
  {
    id: "ppc",
    name: "PPC (Pression Positive Continue)",
    models: [
      {
        id: "s9",
      ...
      },
      {
        ...
        failures: [
          ...
          { title: "Erreur Système (Message d'erreur)", causes: ["Entrée d'air bouchée", "Humidité dans le moteur", "Usure naturelle", "Filtre à air sale", "Obstruction de la grille d'entrée"], solutionsPatient: ["Le filtre à air arrière est-il propre ?", "Avez-vous renversé de l'eau sur l'appareil ?", "Assurez-vous qu'aucun objet (rideau, mur) n'est à moins de 5cm de l'entrée d'air."], solutionsTech: ["Remplacer le filtre.", "Laisser sécher.", "Tester la turbine en mode service.", "Dépoussiérer l'entrée d'air turbine.", "Vérifier le capteur de débit."] },
            ...
            models: [
              ...
              },
              {
                ...
                failures: [
                  ...
                  { title: "Pression insuffisante ou instable (Pression commande basse)", causes: ["Circuit double branche mal connecté au bloc de connexion arrière", "Fuite sur le port de pilotage de la valve", "Membrane valve expiratoire percée", "Capteur de pression décalibré"], solutionsPatient: ["Vérifier que le bloc de connexion est bien clipsé à l'arrière", "Inspecter les raccords du circuit double", "Vérifier l'état de la membrane en silicone"], solutionsTech: ["Vérifier l'étanchéité du bloc de pilotage interne.", "Recalibrer les capteurs de pression.", "Remplacer la membrane de la valve expiratoire."] },
                  { title: "Problème de batterie ou autonomie", causes: ["Batterie interne vieillissante", "Charge incomplète", "Défaut carte alimentation"], solutionsPatient: ["Laisser l'appareil branché en permanence", "Vérifier le voyant de charge", "Tester sur une autre prise murale"], solutionsTech: ["Remplacer la batterie interne", "Vérifier le circuit de charge", "Tester l'alimentation interne."] }
                ]
              }
            ]
          },
            ...
            models: [
              {
                ...
                name: "PB 560",
                failures: [
                  { title: "Erreur Système (Message d'erreur)", causes: ["Paramètres incompatibles", "Erreur décharge totale", "Dysfonctionnement carte mère", "Capteur de débit HS"], solutionsPatient: ["Revoir la prescription", "Valider chaque écran de réglage", "Éteindre et rallumer l'appareil"], solutionsTech: ["Réinitialiser l'appareil via le menu service.", "Vérifier les logs d'erreurs.", "Recalibrer les capteurs."] },
                  { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Câble défaillant", "Fusible interne grillé", "Interrupteur défectueux", "Connecteur embase dessoudé"], solutionsPatient: ["Tester un autre câble standard", "Vérifier l'icône prise sur l'écran", "Appuyer fermement sur l'interrupteur"], solutionsTech: ["Tester le bloc d'alimentation interne.", "Contrôler la continuité de l'interrupteur.", "Vérifier les soudures de l'embase secteur."] },
