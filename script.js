...
let LIBRARY_DATA = [
  {
    ...
    models: [
      { id: "airforce-max", name: "Airforce Max", failures: [
          ...
          { title: "Débit faible ou irrégulier", causes: ["Kit bouché", "Filtre sale", "Compresseur", "Tuyau percé"], solutionsPatient: ["Nettoyer la petite buse du kit", "Vérifier si le tuyau est plié", "Le filtre à air est-il propre ?"], solutionsTech: ["Vérifier la pression de sortie.", "Remplacer le kit piston/membrane.", "Vérifier les fuites internes."] },
          ...
          { title: "Fuites importantes", causes: ["Buse du kit obstruée", "Tuyau usé ou distendu", "Pression sortie trop élevée"], solutionsPatient: ["Nettoyez la buse centrale du kit", "Vérifiez si le raccord du tuyau est gras", "Essayez un tuyau neuf"], solutionsTech: ["Vérifier la pression de service.", "Remplacer le raccord de sortie.", "Tester avec un kit neuf", "Vérifier le clapet anti-retour"] }, // This was already specific enough, no change needed.
          { title: "Erreur Système (Odeur de brûlé / Surchauffe)", causes: ["Filtre à air obstrué", "Moteur fatigué", "Poussière interne"], solutionsPatient: ["Éteindre immédiatement l'appareil", "Remplacer le filtre à air si gris/noir", "Dégager les entrées d'air"], solutionsTech: ["Nettoyage interne.", "Contrôler la consommation moteur.", "Vérifier le ventilateur."] }
        ] },
      { id: "innospire-elegance", name: "Innospire Elegance", failures: [
          ...
          { title: "Débit faible ou irrégulier", causes: ["Kit bouché", "Filtre sale", "Compresseur", "Tuyau percé"], solutionsPatient: ["Avez-vous nettoyé la petite buse du kit ?", "Est-ce que le tuyau est plié ou écrasé ?", "Le filtre à air est-il propre ?"], solutionsTech: ["Vérifier la pression de sortie.", "Remplacer le kit piston/membrane.", "Mesurer le débit air libre"] },
          { title: "Fuites importantes", causes: ["Kit mal assemblé", "Joint usé", "Fissure dans le kit", "Embase de sortie lâche", "Surpression"], solutionsPatient: ["Réassembler correctement le kit.", "Vérifier l'état des joints du kit.", "Vérifier le serrage du tuyau", "Vérifier l'absence de fissure"], solutionsTech: ["Remplacer le kit de nébulisation.", "Vérifier la pression de sortie de l'appareil.", "Changer le raccord de sortie", "Contrôler le joint de culasse"] },
          { title: "Bruit anormal ou vibrations", causes: ["Pieds caoutchouc usés", "Surface instable", "Fixation interne desserrée", "Ventilateur voilé", "Piston grippé"], solutionsPatient: ["Placer sur une surface plane et solide", "Vérifier les 4 pieds sous l'appareil", "S'assurer qu'aucun objet ne vibre contre", "Dégager l'arrière"], solutionsTech: ["Resserrer les fixations compresseur.", "Remplacer les silentblocs.", "Vérifier l'équilibrage ventilateur", "Graissage bielle (si applicable)"] },
          ] },
      { id: "innospire-mini", name: "Innospire Mini", failures: [
          ...
          { title: "Débit faible ou irrégulier", causes: ["Kit bouché", "Filtre sale", "Compresseur", "Niveau batterie bas", "Buse obstruée"], solutionsPatient: ["Avez-vous nettoyé la petite buse du kit ?", "Le filtre à air est-il propre ?", "Vérifier le niveau de batterie", "Tester sur secteur"], solutionsTech: ["Vérifier la pression de sortie.", "Remplacer le compresseur.", "Vérifier la tension moteur", "Mesurer débit de sortie"] },
          ...
          { title: "Problème de batterie ou autonomie", causes: ["Cellules Lithium usées", "Chaleur excessive", "Défaut de charge", "Stockage vide", "Surcharge"], solutionsPatient: ["Utiliser sur secteur", "Retirer la batterie si deformée", "Ne pas charger au soleil", "Vider complètement avant charge"], solutionsTech: ["Remplacer la batterie.", "Vérifier tension chargeur.", "Recalibrer circuit de charge", "Check protection thermique"] },
          { title: "Fuites importantes", causes: ["Fuite kit nébuliseur", "Tuyau micro-percé", "Filtre mal inséré", "Joint culasse", "Raccord cassé"], solutionsPatient: ["Réassembler le kit fermement", "Vérifier l'état du tuyau", "Vérifier le filtre à air", "Appuyer sur le raccord"], solutionsTech: ["Test étanchéité interne.", "Vérifier clapet compresseur.", "Changer les joints internes", "Remplacer embase de sortie"] },
             ] },
          { id: "inspiration-elite", name: "Inspiration Elite", failures: [
          { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté", "Fusible interne grillé", "Interrupteur défaillant", "Coupure secteur"], solutionsPatient: ["Vérifier branchement mural", "Tester sur une autre prise murale", "Vérifier que le bouton est bien sur 'I'"], solutionsTech: ["Tester la continuité du cordon.", "Vérifier l'interrupteur.", "Remplacer le fusible interne.", "Contrôler la carte d'alimentation."] },
          { title: "Débit faible ou irrégulier", causes: ["Kit bouché", "Filtre sale", "Compresseur fatigué", "Tuyau percé", "Fuite interne"], solutionsPatient: ["Nettoyer la buse du kit", "Vérifier que le tuyau n'est pas plié", "Le filtre à air est-il propre ?"], solutionsTech: ["Vérifier la pression de sortie.", "Remplacer le kit piston/membrane.", "Mesurer le débit d'air libre.", "Vérifier l'étanchéité des tubulures internes."] },
              { title: "Bruit anormal ou vibrations", causes: ["Coussinets moteur usés", "Ventilateur touchant le boîtier", "Vis desserrée", "Silentbloc dégradé"], solutionsPatient: ["Vérifier si l'appareil a subi un choc", "S'assurer qu'aucun objet n'est entré dedans", "Placer sur support stable", "Vérifier les patins"], solutionsTech: ["Ouvrir et inspecter la mécanique.", "Remplacer roulements.", "Resserrer le berceau", "Changer silentblocs"] },
              { title: "Fuites importantes", causes: ["Joint interne usé", "Raccord fissuré", "Tuyau débranché", "Fuite membrane"], solutionsPatient: ["Vérifier l'extrémité du tuyau", "Enfoncer le tuyau fermement", "Entendez-vous un pshhh", "Vérifier propreté filtre"], solutionsTech: ["Remplacer le raccord sortie.", "Vérifier tubes internes.", "Test étanchéité culasse", "Changer joint corps"] },
              { title: "Erreur Système (Surchauffe)", causes: ["Entrées air bouchées", "Filtre interne colmaté", "Condensateur défectueux", "Moteur fatigué"], solutionsPatient: ["Dégager l'espace autour de l'appareil", "Changer le filtre à air", "Laisser refroidir 30min", "Ne pas couvrir"], solutionsTech: ["Nettoyage circuit aération.", "Vérifier ventilateur.", "Mesurer T° moteur", "Changer condensateur"] },
          ...
          { id: "pariboy-pro", name: "PariBoy Pro", failures: [
              ...
              { title: "Bruit anormal ou vibrations", causes: ["Moteur desserré", "Segment piston usé", "Choc boîtier", "Objet interne"], solutionsPatient: ["Vérifier que rien ne vibre contre l'appareil", "Placer sur une serviette", "Vérifier les pieds", "Éloigner du mur"], solutionsTech: ["Resserrer berceau moteur.", "Maintenance compresseur.", "Check bielle", "Vérifier ventilateur"] },
              { title: "Fuites importantes", causes: ["Tuyau interne débranché", "Joint culasse HS", "Raccord fissuré", "Filtre mal mis"], solutionsPatient: ["Appareil semble moins puissant", "Sifflement venant de l'intérieur", "Enfoncer raccord", "Vérifier filtre"], solutionsTech: ["Réparation pneumatique interne.", "Changer joint culasse", "Mesurer P. de service", "Remplacer raccord"] },
          ...
          { id: "pariboy-sx", name: "PariBoy SX", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Alimentation", "Cordon", "Interrupteur"], solutionsPatient: ["Est-ce que la prise est bien branchée au mur et à l'appareil ?", "Si vous essayez sur une autre prise, est-ce que ça marche ?", "Le bouton est-il bien sur la position 'I' (Marche) ?"], solutionsTech: ["Tester le cordon d'alimentation.", "Vérifier l'interrupteur.", "Remplacer la carte électronique."] },
              { title: "Débit faible ou irrégulier", causes: ["Kit bouché", "Filtre sale", "Compresseur"], solutionsPatient: ["Avez-vous nettoyé la petite buse du kit ?", "Est-ce que le tuyau est plié ou écrasé ?", "Le filtre à air est-il propre ?"], solutionsTech: ["Mesurer la pression de service.", "Remplacer le compresseur."] },
              { title: "Bruit anormal ou vibrations", causes: ["Amortisseurs moteur usés", "Axe moteur voilé", "Piston grippé", "Surchauffe"], solutionsPatient: ["Poser sur un support stable", "Vérifier les pieds", "S'assurer qu'il respire", "Éteindre 15min"], solutionsTech: ["Remplacer silentblocs.", "Vérifier bielle", "Changer roulements", "Équilibrage turbine"] },
      ...
      { 
        ...
        models: [
          { id: "aidal", name: "AIDAL", failures: [
              ...
              { title: "Bruit anormal ou vibrations", causes: ["Vibrations pompe", "Fixations desserrées", "Choc boîtier", "Usure piston"], solutionsPatient: ["Poser l'appareil sur une surface stable.", "Vérifier les pieds de l'appareil", "S'assurer qu'il ne touche rien", "Vérifier clipsage bocal"], solutionsTech: ["Vérifier les silentblocs.", "Remplacer la pompe.", "Resserrer le berceau", "Vérifier le ventilateur"] },
              { title: "Problème de batterie ou autonomie", causes: ["Usure", "Stockage prolongé", "Décharge profonde", "Surchauffe"], solutionsPatient: ["Brancher sur secteur", "Laisser charger 12h", "Vérifier le voyant charge", "Tester une autre prise"], solutionsTech: ["Changer la batterie", "Contrôler le circuit de charge", "Mesurer tension batterie", "Vérifier carte de gestion"] },
          ...
          { id: "clario-medela", name: "Clario Medela", failures: [
              ...
              { title: "Problème de batterie ou autonomie", causes: ["Batterie usée", "Chargeur", "Connectique", "Surcharge", "Stockage"], solutionsPatient: ["Vérifier le branchement du chargeur.", "Laisser charger 2h minimum.", "Nettoyer les contacts de charge.", "Est-ce que vous êtes dehors avec l'appareil ?", "Vérifier l'icône batterie"], solutionsTech: ["Tester avec un autre chargeur.", "Remplacer la batterie.", "Contrôler carte de charge", "Mesurer courant repos"] }
        ] },
          { id: "aidal-v7-ac", name: "V7+ AC", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Appareil noyé", "Batterie", "Alimentation", "Carte"], solutionsPatient: ["Quand vous le branchez, est-ce qu'une petite lumière s'allume ?", "Ça fait longtemps qu'il n'a pas servi ?"], solutionsTech: ["Vérifier l'absence de liquide dans le compartiment moteur (appareil noyé).", "Tester le chargeur.", "Remplacer la batterie.", "Remplacer la carte électronique."] },
                { title: "Débit faible ou irrégulier", causes: ["Appareil noyé", "Bocal mal clipsé", "Filtre colmaté", "Pompe fatiguée", "Fuite sur le raccord de bocal"], solutionsPatient: ["Sur votre machine il y a un manomètre, est-ce que l'aiguille va sur la gauche ?", "Entendez-vous de l'air s'échapper au niveau du bouchon ?", "Le petit filtre est-il gris ?"], solutionsTech: ["Vérifier l'absence de liquide (noyé).", "Tester la pompe sous charge.", "Vérifier l'étanchéité interne des tubulures.", "Remplacer les joints de bocal."] }
          ] },
          { id: "aidal-v7-ac-batt", name: "V7+ AC-B", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Appareil noyé", "Batterie", "Alimentation", "Carte"], solutionsPatient: ["Quand vous le branchez, est-ce qu'une petite lumière s'allume ?", "Ça fait longtemps qu'il n'a pas servi ?"], solutionsTech: ["Vérifier l'absence de liquide dans le compartiment moteur (appareil noyé).", "Tester le chargeur.", "Remplacer la batterie.", "Remplacer la carte électronique."] },
                { title: "Débit faible ou irrégulier", causes: ["Appareil noyé", "Bocal mal fermé", "Filtre saturé", "Pompe usée", "Tuyau interne déconnecté"], solutionsPatient: ["L'aiguille du manomètre bouge-t-elle ?", "Vérifiez que le bocal est bien vertical et clipsé.", "Changez le filtre antibactérien."], solutionsTech: ["Vérifier l'étanchéité du circuit.", "Tester la pompe.", "Remplacer les clapets si nécessaire."] },
              { title: "Problème de batterie ou autonomie", causes: ["Batterie usée", "Chargeur", "Connectique", "Age", "Fuite courant"], solutionsPatient: ["Vérifier le branchement du chargeur.", "Laisser charger 2h minimum.", "Nettoyer les contacts de charge.", "Est-ce que vous êtes dehors avec l'appareil ?", "Vérifier voyant batterie"], solutionsTech: ["Tester avec un autre chargeur.", "Remplacer la batterie.", "Check nappe batterie", "Calibration"] }
          ] },
          { id: "vacuaide-7314", name: "Vacu-Aid 7314", failures: [
              ...
              { title: "Bruit anormal ou vibrations", causes: ["Pompe", "Fixations", "Vibrations", "Clapet turbine"], solutionsPatient: ["Poser l'appareil sur une surface stable.", "Vérifier bocal bien clipsé", "Serrer le bouchon", "Vider condensation"], solutionsTech: ["Resserrer les fixations moteur.", "Remplacer la pompe.", "Check silentblocs", "Lubrifier (si prévu)"] },
              { title: "Problème de batterie ou autonomie", causes: ["Batterie usée", "Chargeur", "Connectique", "Surchauffe"], solutionsPatient: ["Vérifier le branchement du chargeur.", "Laisser charger 2h minimum.", "Nettoyer les contacts de charge.", "Est-ce que vous êtes dehors avec l'appareil ?", "Vérifier voyant batterie"], solutionsTech: ["Tester avec un autre chargeur.", "Remplacer la batterie.", "Vérifier carte charge", "V tension chargeur"] }
          ] },
          { id: "vacuaide-7325", name: "Vacu-Aid 7325", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Appareil noyé", "Batterie", "Alimentation", "Fusible"], solutionsPatient: ["Quand vous le branchez, est-ce qu'une petite lumière s'allume ?", "Ça fait longtemps qu'il n'a pas servi ?"], solutionsTech: ["Vérifier l'absence de liquide dans le compartiment moteur (appareil noyé).", "Tester le chargeur.", "Remplacer la batterie.", "Vérifier fusible et carte."] },
              { title: "Débit faible ou irrégulier", causes: ["Appareil noyé", "Bocal mal fermé", "Filtre saturé", "Tuyau", "Réglage"], solutionsPatient: ["Sur votre machine il y a un manomètre, est-ce qu'l'aiguille va sur la gauche ?", "Quand la machine tourne, est-ce que vous entendez de l'air s'échapper (un pshhhh) ?", "Est-ce que le petit filtre est devenu gris ou sale ?"], solutionsTech: ["Vérifier l'absence de liquide dans le compartiment moteur (appareil noyé).", "Tester l'étanchéité du circuit interne.", "Mesurer la dépression max.", "Remplacer la pompe."] },
              { title: "Bruit anormal ou vibrations", causes: ["Pompe", "Fixations", "Vibrations", "Coque desserrée"], solutionsPatient: ["Si vous posez l'appareil par terre ou sur une table stable, est-ce qu'il fait moins de bruit ?", "Serrer les vis apparentes", "Vérifier bocal", "Éteindre/rallumer"], solutionsTech: ["Resserrer les fixations moteur.", "Remplacer la pompe.", "Check ventilateur", "Changer silentblocs"] },
              { title: "Problème de batterie ou autonomie", causes: ["Batterie usée", "Chargeur", "Connectique", "Age batterie"], solutionsPatient: ["Vérifier le branchement du chargeur.", "Laisser charger 2h minimum.", "Nettoyer les contacts de charge.", "Est-ce que vous êtes dehors avec l'appareil ?", "Vérifier voyant"], solutionsTech: ["Tester avec un autre chargeur.", "Remplacer la batterie.", "Check tension alim", "Mesurer capa batterie"] }
          ] }
        ]
      },
      {
