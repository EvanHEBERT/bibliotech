...
let LIBRARY_DATA = [
  {
    ...
    models: [
      { id: "airforce-max", name: "Airforce Max", failures: [
          { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté ou défectueux", "Prise murale hors service", "Disjoncteur déclenché", "Interrupteur de l'appareil sur 'Off'", "Fusible interne grillé", "Panne de la carte d'alimentation"], solutionsPatient: ["Vérifiez que le cordon d'alimentation (le gros câble noir) est bien enfoncé dans la prise murale ET à l'arrière de l'appareil.", "Branchez une lampe sur la même prise pour vérifier si elle fonctionne. Si non, vérifiez le disjoncteur de votre domicile.", "Assurez-vous que le bouton Marche/Arrêt (souvent à l'arrière ou sur le côté) est bien sur la position 'I' (Marche).", "Inspectez visuellement le câble sur toute sa longueur pour toute coupure ou dommage."], solutionsTech: ["Tester la continuité du cordon d'alimentation avec un multimètre.", "Vérifier la présence de tension (230V AC) sur la prise murale.", "Contrôler l'interrupteur de l'appareil (continuité en position 'On').", "Ouvrir l'appareil et vérifier le fusible interne sur la carte d'alimentation.", "Mesurer les tensions de sortie de la carte d'alimentation."] },
          { title: "Débit faible ou irrégulier", causes: ["Kit de nébulisation bouché", "Filtre à air sale ou colmaté", "Tuyau plié ou percé", "Usure du compresseur"], solutionsPatient: ["Démontez le kit (la partie où vous mettez le médicament) et nettoyez la petite buse centrale à l'eau chaude. Assurez-vous qu'aucun résidu ne bloque le passage.", "Localisez le filtre à air (petite trappe sur le côté ou à l'arrière). S'il est gris ou noir, remplacez-le.", "Assurez-vous que le long tuyau en plastique n'est ni plié, ni écrasé."], solutionsTech: ["Mesurer la pression de sortie du compresseur avec un manomètre (doit être > 1 bar).", "Remplacer le kit piston/membrane du compresseur (pièce d'usure).", "Rechercher des fuites d'air sur les tubulures internes."] },
          { title: "Bruit anormal ou vibrations", causes: ["Fixations internes desserrées", "Usure du compresseur (roulements, piston)", "Surface d'utilisation instable", "Filtre à air mal inséré"], solutionsPatient: ["Placez l'appareil sur une surface dure et stable (pas sur un tapis).", "Posez l'appareil sur une serviette pliée pour voir si le bruit diminue.", "Vérifiez que le capot du filtre à air est bien fermé.", "Assurez-vous que rien ne touche l'appareil (mur, meuble)."], solutionsTech: ["Ouvrir l'appareil et resserrer les vis du berceau moteur/compresseur.", "Inspecter les silentblocs (supports en caoutchouc) pour tout signe d'usure ou d'écrasement.", "Vérifier le jeu dans l'axe du piston/bielle.", "Remplacer le bloc compresseur si le bruit de roulement persiste."] }, // MODIFIED
          ...
          { title: "Fuites importantes (air ou liquide)", causes: ["Tuyau mal enfoncé ou usé", "Kit de nébulisation fissuré ou mal assemblé", "Fuite interne au niveau du compresseur"], solutionsPatient: ["Entendez-vous un sifflement près de la sortie d'air de l'appareil ? Enfoncez bien le tuyau.", "Vérifiez que le kit (partie transparente) est bien vissé et non fissuré.", "L'appareil semble-t-il moins puissant que d'habitude ?"], solutionsTech: ["Vérifier la pression de service.", "Remplacer le raccord de sortie d'air.", "Inspecter les tubulures internes pour détecter une déconnexion ou une fissure.", "Vérifier le joint de culasse du compresseur."] },
          { title: "Odeur de brûlé ou surchauffe", causes: ["Filtre à air obstrué", "Moteur en surchauffe", "Poussière accumulée à l'intérieur"], solutionsPatient: ["Éteindre et débrancher immédiatement l'appareil.", "Vérifiez que le filtre à air (souvent une petite mousse) n'est pas noir ou colmaté.", "Assurez-vous que les grilles de ventilation ne sont pas bloquées."], solutionsTech: ["Nettoyage interne complet de l'appareil.", "Contrôler la consommation électrique du moteur.", "Vérifier le bon fonctionnement du ventilateur de refroidissement."] }
        ] },
      { id: "innospire-elegance", name: "Innospire Elegance", failures: [
          { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté ou défectueux", "Prise murale hors service", "Disjoncteur déclenché", "Interrupteur de l'appareil sur 'Off'", "Fusible interne grillé", "Panne de la carte d'alimentation"], solutionsPatient: ["Vérifiez que le cordon d'alimentation (le gros câble noir) est bien enfoncé dans la prise murale ET à l'arrière de l'appareil.", "Branchez une lampe sur la même prise pour vérifier si elle fonctionne. Si non, vérifiez le disjoncteur de votre domicile.", "Assurez-vous que le bouton Marche/Arrêt (souvent à l'arrière ou sur le côté) est bien sur la position 'I' (Marche).", "Inspectez visuellement le câble sur toute sa longueur pour toute coupure ou dommage."], solutionsTech: ["Tester la continuité du cordon d'alimentation avec un multimètre.", "Vérifier la présence de tension (230V AC) sur la prise murale.", "Contrôler l'interrupteur de l'appareil (continuité en position 'On').", "Ouvrir l'appareil et vérifier le fusible interne sur la carte d'alimentation.", "Mesurer les tensions de sortie de la carte d'alimentation."] },
          { title: "Débit faible ou irrégulier", causes: ["Kit de nébulisation bouché", "Filtre à air sale ou colmaté", "Tuyau plié ou percé", "Usure du compresseur"], solutionsPatient: ["Démontez le kit (la partie où vous mettez le médicament) et nettoyez la petite buse centrale à l'eau chaude. Assurez-vous qu'aucun résidu ne bloque le passage.", "Localisez le filtre à air (petite trappe sur le côté ou à l'arrière). S'il est gris ou noir, remplacez-le.", "Assurez-vous que le long tuyau en plastique n'est ni plié, ni écrasé."], solutionsTech: ["Mesurer la pression de sortie du compresseur avec un manomètre (doit être > 1 bar).", "Remplacer le kit piston/membrane du compresseur (pièce d'usure).", "Rechercher des fuites d'air sur les tubulures internes."] },
          { title: "Fuites importantes (air ou liquide)", causes: ["Kit de nébulisation mal assemblé ou fissuré", "Joint du kit usé", "Raccord de sortie d'air de l'appareil lâche", "Fuite interne"], solutionsPatient: ["Démontez et remontez soigneusement le kit de nébulisation.", "Vérifiez que le tuyau est bien enfoncé sur la sortie d'air.", "Inspectez le kit transparent pour toute fissure.", "Entendez-vous un sifflement provenant de l'intérieur de l'appareil ?"], solutionsTech: ["Remplacer le kit de nébulisation.", "Vérifier la pression de sortie (une surpression peut causer des fuites).", "Resserrer ou remplacer l'embase de sortie d'air.", "Inspecter les tubulures internes et le joint de culasse du compresseur."] },
          { title: "Bruit anormal ou vibrations", causes: ["Pieds en caoutchouc usés ou manquants", "Surface d'utilisation instable", "Fixations internes du compresseur desserrées", "Usure du piston/bielle"], solutionsPatient: ["Placez l'appareil sur une surface dure et stable (pas sur un tapis).", "Vérifiez que les 4 pieds en caoutchouc sont présents sous l'appareil.", "Le bruit est-il un 'claquement' régulier ou une vibration générale ?", "Assurez-vous que rien ne touche l'appareil (mur, meuble)."], solutionsTech: ["Ouvrir l'appareil et resserrer les vis du berceau moteur/compresseur.", "Inspecter les silentblocs (supports en caoutchouc) pour tout signe d'usure ou d'écrasement.", "Vérifier le jeu dans l'axe du piston/bielle.", "Remplacer le bloc compresseur si le bruit de roulement persiste."] }, // MODIFIED
          ] },
      { id: "innospire-mini", name: "Innospire Mini", failures: [
          { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Batterie amovible déchargée", "Chargeur défectueux ou non compatible", "Port de charge de l'appareil endommagé", "Batterie HS", "Panne carte mère"], solutionsPatient: ["Branchez l'appareil avec son chargeur d'origine. Le voyant de charge (souvent une LED orange ou verte) s'allume-t-il ?", "Retirez la batterie (si possible), branchez l'appareil sur secteur et essayez de le démarrer. S'il démarre, la batterie est probablement en cause.", "Vérifiez que le port de charge sur l'appareil n'est pas obstrué par de la poussière."], solutionsTech: ["Tester avec un chargeur compatible et fonctionnel.", "Mesurer la tension de sortie du chargeur.", "Vérifier la tension aux bornes de la batterie.", "Inspecter le connecteur de charge sur la carte mère pour tout dommage."] },
          { title: "Débit faible ou irrégulier", causes: ["Kit de nébulisation bouché", "Filtre à air sale", "Niveau de batterie faible", "Usure du compresseur"], solutionsPatient: ["Démontez le kit et nettoyez la petite buse centrale à l'eau chaude.", "Localisez le petit filtre à air et remplacez-le s'il est sale.", "Branchez l'appareil sur secteur. Si le débit s'améliore, la batterie est faible.", "Assurez-vous que le tuyau n'est ni plié, ni écrasé."], solutionsTech: ["Mesurer la pression de sortie du compresseur avec un manomètre.", "Vérifier la tension d'alimentation du moteur du compresseur.", "Remplacer le bloc compresseur si usé."] },
          { title: "Voyant de charge ne s'allume pas", causes: ["Chargeur défectueux", "Port de charge endommagé", "Batterie HS", "Contacts sales", "Câble USB coupé"], solutionsPatient: ["Tester avec un autre chargeur.", "Vérifier que le port de charge n'est pas obstrué.", "Nettoyer les contacts batterie", "Essuyer la fiche"], solutionsTech: ["Remplacer le chargeur.", "Vérifier la carte de charge.", "Remplacer le port micro-USB", "Tester l'alimentation interne"] },
          { title: "Problème de batterie ou autonomie", causes: ["Cellules Lithium usées (fin de vie)", "Batterie gonflée ou déformée", "Défaut du circuit de charge", "Surchauffe pendant la charge"], solutionsPatient: ["L'autonomie est-elle très faible (moins de 15 min) ?", "La batterie semble-t-elle gonflée ? Si oui, retirez-la et ne l'utilisez plus.", "Laissez l'appareil charger complètement sans l'utiliser.", "Évitez de charger l'appareil au soleil ou près d'une source de chaleur."], solutionsTech: ["Remplacer la batterie.", "Vérifier la tension de sortie du chargeur.", "Contrôler le circuit de gestion de la batterie (BMS).", "Vérifier la sonde de température de la batterie."] },
          { title: "Fuites importantes (air ou liquide)", causes: ["Kit de nébulisation mal assemblé ou fissuré", "Tuyau micro-percé", "Filtre à air mal inséré créant une fuite", "Fuite interne au compresseur"], solutionsPatient: ["Réassemblez fermement le kit de nébulisation.", "Inspectez le tuyau pour toute petite coupure ou trou.", "Vérifiez que le filtre à air est bien en place et que son capot est fermé.", "Entendez-vous un sifflement provenant de l'intérieur de l'appareil ?"], solutionsTech: ["Effectuer un test d'étanchéité interne.", "Vérifier le clapet du compresseur.", "Remplacer les joints internes du compresseur.", "Remplacer l'embase de sortie d'air si elle est fissurée."] },
             ] },
          { id: "inspiration-elite", name: "Inspiration Elite", failures: [
          { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté ou défectueux", "Prise murale hors service", "Disjoncteur déclenché", "Interrupteur de l'appareil sur 'Off'", "Fusible interne grillé", "Panne de la carte d'alimentation"], solutionsPatient: ["Vérifiez que le cordon d'alimentation (le gros câble noir) est bien enfoncé dans la prise murale ET à l'arrière de l'appareil.", "Branchez une lampe sur la même prise pour vérifier si elle fonctionne. Si non, vérifiez le disjoncteur de votre domicile.", "Assurez-vous que le bouton Marche/Arrêt (souvent à l'arrière ou sur le côté) est bien sur la position 'I' (Marche).", "Inspectez visuellement le câble sur toute sa longueur pour toute coupure ou dommage."], solutionsTech: ["Tester la continuité du cordon d'alimentation avec un multimètre.", "Vérifier la présence de tension (230V AC) sur la prise murale.", "Contrôler l'interrupteur de l'appareil (continuité en position 'On').", "Ouvrir l'appareil et vérifier le fusible interne sur la carte d'alimentation.", "Mesurer les tensions de sortie de la carte d'alimentation."] },
          { title: "Débit faible ou irrégulier", causes: ["Kit de nébulisation bouché", "Filtre à air sale ou colmaté", "Tuyau plié ou percé", "Usure du compresseur"], solutionsPatient: ["Démontez le kit (la partie où vous mettez le médicament) et nettoyez la petite buse centrale à l'eau chaude. Assurez-vous qu'aucun résidu ne bloque le passage.", "Localisez le filtre à air (petite trappe sur le côté ou à l'arrière). S'il est gris ou noir, remplacez-le.", "Assurez-vous que le long tuyau en plastique n'est ni plié, ni écrasé."], solutionsTech: ["Mesurer la pression de sortie du compresseur avec un manomètre (doit être > 1 bar).", "Remplacer le kit piston/membrane du compresseur (pièce d'usure).", "Rechercher des fuites d'air sur les tubulures internes."] },
              { title: "Bruit anormal ou vibrations", causes: ["Usure des roulements du moteur", "Ventilateur de refroidissement touchant le boîtier", "Vis de fixation du moteur desserrée", "Silentblocs (supports moteur) dégradés"], solutionsPatient: ["L'appareil a-t-il subi un choc récemment ?", "Le bruit est-il un sifflement aigu ou un claquement ?", "Placez l'appareil sur une surface stable et plane.", "Vérifiez que les patins en caoutchouc sous l'appareil sont présents."], solutionsTech: ["Ouvrir le boîtier et inspecter visuellement la mécanique.", "Remplacer les roulements du moteur si le bruit est un sifflement.", "Resserrer les vis du berceau moteur.", "Remplacer les silentblocs s'ils sont écrasés ou craquelés."] }, // MODIFIED
              { title: "Fuites importantes (air ou liquide)", causes: ["Joint interne du compresseur usé", "Raccord de sortie d'air fissuré", "Tuyau interne débranché", "Fuite au niveau de la membrane"], solutionsPatient: ["Vérifiez que l'extrémité du tuyau est bien enfoncée sur la sortie.", "Entendez-vous un sifflement provenant de l'intérieur de l'appareil ?", "L'appareil semble-t-il moins puissant que d'habitude ?"], solutionsTech: ["Remplacer le raccord de sortie d'air.", "Inspecter les tubulures internes et les reconnecter.", "Effectuer un test d'étanchéité de la culasse.", "Remplacer le joint du corps de pompe."] },
              { title: "Surchauffe de l'appareil", causes: ["Entrées d'air bouchées", "Filtre à air colmaté", "Condensateur de moteur défectueux", "Moteur en fin de vie"], solutionsPatient: ["Dégagez l'espace autour de l'appareil pour qu'il puisse respirer.", "Changez le filtre à air s'il est sale.", "Laissez refroidir l'appareil 30 minutes avant de le réutiliser.", "Ne couvrez jamais l'appareil pendant son fonctionnement."], solutionsTech: ["Nettoyer le circuit d'aération interne.", "Vérifier le bon fonctionnement du ventilateur.", "Mesurer la température du moteur.", "Tester et remplacer le condensateur si nécessaire."] },
              { title: "Tuyau qui saute de l'appareil", causes: ["Pression excessive (kit bouché)", "Extrémité tuyau lâche", "Humidité sur raccord", "Raccord usé"], solutionsPatient: ["Nettoyer la buse du kit", "Couper 1cm du bout du tuyau", "Tester un nouveau tuyau", "Essuyer le raccord"], solutionsTech: ["Mesurer pression maximale.", "Remplacer embase sortie", "Vérifier limiteur de pression"] }
          ] },
          { id: "pariboy-pro", name: "PariBoy Pro", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté ou défectueux", "Prise murale hors service", "Disjoncteur déclenché", "Interrupteur de l'appareil sur 'Off'", "Fusible interne grillé", "Panne de la carte d'alimentation"], solutionsPatient: ["Vérifiez que le cordon d'alimentation (le gros câble noir) est bien enfoncé dans la prise murale ET à l'arrière de l'appareil.", "Branchez une lampe sur la même prise pour vérifier si elle fonctionne. Si non, vérifiez le disjoncteur de votre domicile.", "Assurez-vous que le bouton Marche/Arrêt (souvent à l'arrière ou sur le côté) est bien sur la position 'I' (Marche).", "Inspectez visuellement le câble sur toute sa longueur pour toute coupure ou dommage."], solutionsTech: ["Tester la continuité du cordon d'alimentation avec un multimètre.", "Vérifier la présence de tension (230V AC) sur la prise murale.", "Contrôler l'interrupteur de l'appareil (continuité en position 'On').", "Ouvrir l'appareil et vérifier le fusible interne sur la carte d'alimentation.", "Mesurer les tensions de sortie de la carte d'alimentation."] },
              { title: "Débit faible ou irrégulier", causes: ["Kit de nébulisation bouché", "Filtre à air sale ou colmaté", "Tuyau plié ou percé", "Usure du compresseur"], solutionsPatient: ["Démontez le kit (la partie où vous mettez le médicament) et nettoyez la petite buse centrale à l'eau chaude. Assurez-vous qu'aucun résidu ne bloque le passage.", "Localisez le filtre à air (petite trappe sur le côté ou à l'arrière). S'il est gris ou noir, remplacez-le.", "Assurez-vous que le long tuyau en plastique n'est ni plié, ni écrasé."], solutionsTech: ["Mesurer la pression de service avec un manomètre.", "Remplacer le bloc compresseur si usé ou bruyant.", "Rechercher des fuites d'air sur les tubulures internes."] },
              { title: "Bruit anormal ou vibrations", causes: ["Fixations internes du compresseur desserrées", "Usure du piston ou de la bielle", "Surface d'utilisation instable", "Objet étranger dans le boîtier"], solutionsPatient: ["Placez l'appareil sur une surface dure et stable (pas sur un tapis).", "Le bruit est-il un 'claquement' régulier ou une vibration générale ?", "Assurez-vous que rien ne touche l'appareil (mur, meuble).", "L'appareil a-t-il subi un choc récemment ?"], solutionsTech: ["Ouvrir l'appareil et resserrer les vis du berceau moteur/compresseur.", "Inspecter les silentblocs (supports en caoutchouc) pour tout signe d'usure ou d'écrasement.", "Effectuer une maintenance du compresseur (remplacement segment, bielle).", "Vérifier le ventilateur de refroidissement."] }, // MODIFIED
              { title: "Fuites importantes (air ou liquide)", causes: ["Tuyau interne débranché", "Joint de culasse du compresseur défectueux", "Raccord de sortie fissuré", "Filtre à air mal inséré"], solutionsPatient: ["L'appareil semble-t-il moins puissant et plus bruyant ?", "Entendez-vous un sifflement provenant de l'intérieur de l'appareil ?", "Vérifiez que le tuyau est bien enfoncé sur la sortie.", "Vérifiez que le filtre est bien en place."], solutionsTech: ["Effectuer une réparation pneumatique interne (rebrancher tuyau).", "Remplacer le joint de culasse.", "Mesurer la pression de service pour confirmer la fuite.", "Remplacer le raccord de sortie."] },
              { title: "Interrupteur bloqué", causes: ["Résidus de médicaments", "Ressort cassé", "Boîtier déformé", "Choc"], solutionsPatient: ["Nettoyer le bouton au sec", "Appuyer plusieurs fois", "Dégripper au sec", "Vérifier aspect bouton"], solutionsTech: ["Remplacer interrupteur.", "Vérifier alignement", "Changer façade", "Contrôler câblage"] },
              { title: "Pas de brouillard / Buse bouchée", causes: ["Orifice buse obstrué", "Filtre mouillé", "Kit déformé", "Médicament gras"], solutionsPatient: ["Déboucher la buse du kit", "Sécher ou changer le filtre", "Utiliser un kit neuf", "Bien visser le kit"], solutionsTech: ["Vérifier débit (min 3.5L/min).", "Mesurer pression", "Tester compresseur", "Nettoyer culasse"] }
          ] },
          { id: "pariboy-sx", name: "PariBoy SX", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté ou défectueux", "Prise murale hors service", "Disjoncteur déclenché", "Interrupteur de l'appareil sur 'Off'", "Fusible interne grillé", "Panne de la carte d'alimentation"], solutionsPatient: ["Vérifiez que le cordon d'alimentation (le gros câble noir) est bien enfoncé dans la prise murale ET à l'arrière de l'appareil.", "Branchez une lampe sur la même prise pour vérifier si elle fonctionne. Si non, vérifiez le disjoncteur de votre domicile.", "Assurez-vous que le bouton Marche/Arrêt (souvent à l'arrière ou sur le côté) est bien sur la position 'I' (Marche).", "Inspectez visuellement le câble sur toute sa longueur pour toute coupure ou dommage."], solutionsTech: ["Tester la continuité du cordon d'alimentation avec un multimètre.", "Vérifier la présence de tension (230V AC) sur la prise murale.", "Contrôler l'interrupteur de l'appareil (continuité en position 'On').", "Ouvrir l'appareil et vérifier le fusible interne sur la carte d'alimentation.", "Mesurer les tensions de sortie de la carte d'alimentation."] },
              { title: "Débit faible ou irrégulier", causes: ["Kit de nébulisation bouché", "Filtre à air sale ou colmaté", "Tuyau plié ou percé", "Usure du compresseur"], solutionsPatient: ["Démontez le kit (la partie où vous mettez le médicament) et nettoyez la petite buse centrale à l'eau chaude. Assurez-vous qu'aucun résidu ne bloque le passage.", "Localisez le filtre à air (petite trappe sur le côté ou à l'arrière). S'il est gris ou noir, remplacez-le.", "Assurez-vous que le long tuyau en plastique n'est ni plié, ni écrasé."], solutionsTech: ["Mesurer la pression de service avec un manomètre.", "Remplacer le bloc compresseur si usé ou bruyant.", "Rechercher des fuites d'air sur les tubulures internes."] },
              { title: "Bruit anormal ou vibrations", causes: ["Amortisseurs (silentblocs) du moteur usés", "Axe moteur voilé suite à un choc", "Usure du piston/bielle", "Surchauffe du moteur"], solutionsPatient: ["Placez l'appareil sur une surface dure et stable.", "Vérifiez que les 4 pieds en caoutchouc sont présents.", "Assurez-vous que les grilles de ventilation ne sont pas obstruées.", "Laissez l'appareil refroidir 30 minutes s'il est chaud."], solutionsTech: ["Remplacer les silentblocs du berceau moteur.", "Inspecter l'axe de la bielle et du piston.", "Remplacer les roulements du moteur si le bruit est un sifflement aigu.", "Vérifier le fonctionnement du ventilateur de refroidissement."] }, // MODIFIED
              { title: "Débit saccadé", causes: ["Membrane compresseur usée", "Clapets fatigués", "Fuite interne", "Kit inadapté"], solutionsPatient: ["Vérifier si le bruit change", "Vérifier le filtre", "Tester autre tuyau", "Serrer le kit"], solutionsTech: ["Révision tête compresseur.", "Vérifier clapets", "Tester étanchéité", "Mesurer P. de cycle"] },
              { title: "Odeur de chaud", causes: ["Moteur surchauffe", "Ventilation interne obstruée", "Poussière sur bobinage", "Surchage électrique"], solutionsPatient: ["Vérifier le dessous de l'appareil", "Changer le filtre", "Dégager l'espace", "Aérer la pièce"], solutionsTech: ["Contrôler température moteur.", "Nettoyage interne", "Vérifier ventilateur", "Mesurer ampérage"] },
              { title: "Débit faible ou irrégulier", causes: ["Condensateur HS", "Usure mécanique", "Tension faible", "Filtre saturé"], solutionsPatient: ["Moteur peine à démarrer ?", "Ronflement sans air ?", "Changer de prise", "Remplacer filtre"], solutionsTech: ["Changer condensateur.", "Révision moteur", "Tester tension", "Maintenance compresseur"] }
          ] }
        ]
      },
      { 
        ...
        models: [
          { id: "aidal", name: "AIDAL", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Appareil noyé (liquide dans le moteur)", "Cordon d'alimentation défectueux", "Fusible grillé", "Interrupteur cassé"], solutionsPatient: ["Quand vous appuyez sur Marche, est-ce qu'il se passe quelque chose (bruit, lumière) ?", "Est-ce qu'il est tombé ou a aspiré du liquide récemment ?", "Vérifiez que le cordon est bien branché au mur et à l'appareil."], solutionsTech: ["Vérifier l'absence de liquide dans le compartiment moteur (appareil noyé).", "Tester le cordon.", "Vérifier l'interrupteur et le fusible.", "Remplacer la carte."] },
              { title: "Aspiration faible ou nulle", causes: ["Fuite sur le circuit", "Filtre antibactérien colmaté", "Tuyau d'aspiration bouché", "Pompe à vide usée", "Appareil noyé"], solutionsPatient: ["Le couvercle du bocal est-il bien vissé/clipsé ? Entendez-vous un sifflement ?", "Le petit filtre blanc/bleu est-il humide ou sale ?", "Le tuyau d'aspiration n'est-il pas bouché par des sécrétions séchées ?", "Tournez le bouton de réglage au maximum. L'aiguille du manomètre bouge-t-elle ?"], solutionsTech: ["Vérifier l'étanchéité du circuit (bocal, joints, tuyaux).", "Mesurer la dépression maximale avec un vacuomètre.", "Vérifier l'absence de liquide dans le compartiment moteur (noyé).", "Remplacer la pompe à vide."] },
              { title: "Bruit anormal ou vibrations", causes: ["Usure de la pompe à vide", "Fixations de la pompe desserrées", "Pieds en caoutchouc manquants ou usés", "Bocal mal clipsé"], solutionsPatient: ["Placez l'appareil sur une surface dure et stable.", "Vérifiez que les 4 pieds en caoutchouc sont présents sous l'appareil.", "Assurez-vous que le bocal est bien enclenché et ne vibre pas.", "Le bruit est-il un 'claquement' ou une vibration générale ?"], solutionsTech: ["Inspecter les silentblocs de la pompe et les resserrer.", "Remplacer les silentblocs s'ils sont écrasés ou craquelés.", "Vérifier le jeu dans l'axe de la pompe.", "Remplacer la pompe à vide si le bruit persiste."] },
              { title: "Problème de batterie ou autonomie", causes: ["Batterie Plomb/AGM en fin de vie", "Stockage prolongé sans charge", "Décharge profonde répétée", "Défaut du circuit de charge"], solutionsPatient: ["Laissez l'appareil branché sur secteur pendant au moins 12 heures sans interruption.", "Le voyant de charge (souvent orange ou vert) est-il allumé lorsque l'appareil est branché ?", "L'appareil fonctionne-t-il sur secteur mais pas sur batterie ?", "La batterie a-t-elle plus de 2-3 ans ?"], solutionsTech: ["Remplacer la batterie (souvent de type Plomb-Acide).", "Contrôler le circuit de charge sur la carte mère.", "Mesurer la tension de la batterie à vide et en charge.", "Tester la capacité de la batterie sous une charge contrôlée."] },
              { title: "Erreur Système (Message d'erreur)", causes: ["Surchauffe", "Batterie basse", "Circuit bouché", "Capteur HS"], solutionsPatient: ["Brancher l'appareil", "Dégager les entrées d'air", "Vérifier si bocal plein", "Éteindre/Rallumer"], solutionsTech: ["Vérifier circuit de charge", "Tester sonde thermique", "Check capteur de vide", "Révision moteur"] }
        ] },
          { id: "clario-medela", name: "Clario Medela", failures: [
              ...
              { 
                title: "Aspiration faible ou nulle", 
                causes: ["Appareil noyé", "Bocal mal fermé", "Filtre saturé", "Tuyau", "Réglage", "Membrane HS"], 
                solutionsPatient: ["Sur votre machine il y a un manomètre, est-ce que l'aiguille va sur la gauche ?", "Quand la machine tourne, est-ce que vous entendez de l'air s'échapper (un pshhhh) ?", "Est-ce que le petit filtre est devenu gris ou sale ?", "Vérifier insertion bocal", "Pousser le bouchon"], 
              ...
              { title: "Bruit anormal ou vibrations", causes: ["Usure de la pompe à vide", "Fixations de la pompe desserrées", "Pieds en caoutchouc manquants ou usés", "Bocal mal clipsé"], solutionsPatient: ["Placez l'appareil sur une surface dure et stable.", "Vérifiez que les 4 pieds en caoutchouc sont présents sous l'appareil.", "Assurez-vous que le bocal est bien enclenché et ne vibre pas.", "Le bruit est-il un 'claquement' ou une vibration générale ?"], solutionsTech: ["Inspecter les silentblocs de la pompe et les resserrer.", "Remplacer les silentblocs s'ils sont écrasés ou craquelés.", "Vérifier le jeu dans l'axe de la pompe.", "Remplacer la pompe à vide si le bruit persiste."] },
              { title: "Problème de batterie ou autonomie", causes: ["Batterie NiMH usée", "Chargeur défectueux", "Contacts de batterie sales ou oxydés", "Stockage prolongé sans charge"], solutionsPatient: ["Vérifiez que le chargeur est bien branché. Le voyant de charge est-il allumé ?", "Laissez charger l'appareil au moins 4 heures.", "Nettoyez les contacts métalliques de la batterie et de l'appareil avec un chiffon sec.", "L'appareil fonctionne-t-il sur secteur mais pas sur batterie ?"], solutionsTech: ["Tester avec un autre chargeur compatible.", "Remplacer la batterie NiMH.", "Contrôler la carte de gestion de charge.", "Mesurer le courant de repos pour détecter une décharge anormale."] }
        ] },
          ...
          { id: "aidal-v7-ac-batt", name: "V7+ AC-Batterie", failures: [
              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Appareil noyé", "Batterie", "Alimentation", "Carte"], solutionsPatient: ["Quand vous le branchez, est-ce qu'une petite lumière s'allume ?", "Ça fait longtemps qu'il n'a pas servi ?"], solutionsTech: ["Vérifier l'absence de liquide dans le compartiment moteur (appareil noyé).", "Tester le chargeur.", "Remplacer la batterie.", "Remplacer la carte électronique."] },
                { title: "Aspiration faible ou nulle", causes: ["Fuite sur le circuit", "Filtre antibactérien colmaté", "Tuyau d'aspiration bouché", "Pompe à vide usée", "Appareil noyé"], solutionsPatient: ["Le couvercle du bocal est-il bien vissé/clipsé ? Entendez-vous un sifflement ?", "Le petit filtre blanc/bleu est-il humide ou sale ?", "Le tuyau d'aspiration n'est-il pas bouché par des sécrétions séchées ?", "Tournez le bouton de réglage au maximum. L'aiguille du manomètre bouge-t-elle ?"], solutionsTech: ["Vérifier l'étanchéité du circuit (bocal, joints, tuyaux).", "Mesurer la dépression maximale avec un vacuomètre.", "Vérifier l'absence de liquide dans le compartiment moteur (noyé).", "Remplacer la pompe à vide."] },
              { title: "Problème de batterie ou autonomie", causes: ["Batterie Plomb/AGM en fin de vie", "Stockage prolongé sans charge", "Décharge profonde répétée", "Défaut du circuit de charge"], solutionsPatient: ["Laissez l'appareil branché sur secteur pendant au moins 12 heures sans interruption.", "Le voyant de charge (souvent orange ou vert) est-il allumé lorsque l'appareil est branché ?", "L'appareil fonctionne-t-il sur secteur mais pas sur batterie ?", "La batterie a-t-elle plus de 2-3 ans ?"], solutionsTech: ["Remplacer la batterie (souvent de type Plomb-Acide).", "Contrôler le circuit de charge sur la carte mère.", "Mesurer la tension de la batterie à vide et en charge.", "Tester la capacité de la batterie sous une charge contrôlée."] }
          ] },
        ...
        subTypes: [
          { id: "hum-interne", name: "Internes (dépendants)", models: [
            { id: "dreamstation-hum", name: "DreamStation", failures: [
                    { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Plaque défectueuse", "Menu désactivé", "Réglage trop élevé"], solutionsPatient: ["Vérifier l'activation dans le menu Confort", "Baisser le réglage si condensation", "Placer la machine plus bas que le lit", "Utiliser une housse de tuyau"], solutionsTech: ["Mesurer la tension de l'embase", "Tester la résistance de chauffe", "Vérifier la sonde thermique"] },
                    { title: "Fuites importantes (Bac ou Circuit)", causes: ["Réservoir fissuré", "Joint du couvercle mal mis", "Niveau d'eau > MAX"], solutionsPatient: ["Vérifier que le joint bleu est plat", "Ne pas dépasser la ligne MAX", "Essuyer le dessous du bac avant insertion"], solutionsTech: ["Remplacer le joint du couvercle", "Changer le réservoir complet", "Vérifier l'étanchéité de l'embase"] },
                    { title: "Bruit anormal ou vibrations", causes: ["Condensation dans le tuyau (glouglou)", "Réservoir mal cliqué"], solutionsPatient: ["Vider l'eau du tuyau", "Enfoncer le bac jusqu'au clic"], solutionsTech: ["Vérifier l'alignement de sortie d'air"] }
            ] },
            { id: "h41", name: "H41", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Plaque chauffante HS", "Option désactivée", "Bac entartré", "Mauvais couplage"], solutionsPatient: ["Vérifier l'activation menu patient", "Enfoncer le bac fermement", "Détartrer au vinaigre blanc", "Ajuster le réglage de chauffe"], solutionsTech: ["Tester la résistance de la plaque", "Vérifier le fusible thermique", "Contrôler la sonde", "Mesurer Ohms résistance"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Joint de bac usé", "Réservoir fissuré (choc)", "Niveau d'eau > MAX"], solutionsPatient: ["Vérifier le joint de bac", "Insérer le bac jusqu'au clic", "Changer le réservoir si fissuré"], solutionsTech: ["Remplacer le joint d'étanchéité", "Changer le réservoir complet"] },
                { title: "Bruit anormal ou vibrations", causes: ["Réservoir mal enclenché", "Condensation (glouglou)", "Joint d'embase desséché"], solutionsPatient: ["Vérifier l'insertion du bac", "Vider l'eau du tuyau", "Placer l'appareil sur une surface plane"], solutionsTech: ["Vérifier l'état du joint d'embase", "Inspecter les fixations plaque"] }
            ] },
            { id: "humidair", name: "HumidAir", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Connecteurs oxydés", "Plaque défectueuse", "Réglage bas"], solutionsPatient: ["Nettoyer contacts au dos du bac", "Pousser le bac jusqu'au clic", "Passer réglage sur 'Auto'"], solutionsTech: ["Vérifier continuité circuit", "Mesurer tension embase", "Remplacer plaque"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Bac mal inséré", "Joint de réservoir pincé", "Réservoir calcaire"], solutionsPatient: ["Vérifier le joint silicone", "Détartrer au vinaigre blanc", "Enfoncer le réservoir à fond"], solutionsTech: ["Remplacer le joint silicone", "Tester avec un bac neuf"] }
            ] },
            { id: "hum-breas", name: "Breas", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Plaque HS", "Option désactivée", "Mauvais clipsage"], solutionsPatient: ["Vérifier activation menu", "S'assurer du clic d'enclenchement", "Attendre 15 min de préchauffage"], solutionsTech: ["Remplacer la plaque", "Mesurer Ohms résistance", "Check nappe interne"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Bac mal fermé", "Joint usé", "Réservoir fissuré"], solutionsPatient: ["Vérifier que le joint blanc est plat", "Vérifier l'absence de fissures", "Vérifier la fermeture du bac"], solutionsTech: ["Remplacer le joint", "Changer le réservoir complet"] }
            ] },
            { id: "hum-sys1", name: "System One", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Plaque HS", "Alim 60W au lieu de 80W", "Réglage trop haut"], solutionsPatient: ["Vérifier voyant bleu allumé", "Nettoyer contacts métalliques", "Pousser le bac à fond"], solutionsTech: ["Tester avec bloc 80W", "Remplacer embase chauffante", "Vérifier Ohms"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Joint transparent usé", "Couvercle mal clipsé", "Réservoir fissuré"], solutionsPatient: ["Vérifier le joint interne", "Clipser les 4 points du couvercle", "Vérifier l'étanchéité du coude"], solutionsTech: ["Remplacer le joint interne", "Changer le réservoir complet"] }
            ] },
            { id: "prisma-aqua", name: "PrismaAQUA", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Résistance HS", "Bac vide", "Réglage bas", "Bac entartré"], solutionsPatient: ["Vérifier symbole chauffe écran", "Détartrer au vinaigre blanc", "Augmenter niveau humidité"], solutionsTech: ["Tester résistance (Ohms)", "Remplacer l'embase", "Vérifier sonde thermique"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Réservoir fissuré", "Joint de couvercle mal mis"], solutionsPatient: ["Vérifier l'absence d'eau sous l'appareil", "Vérifier que le joint bleu est plat"], solutionsTech: ["Remplacer le réservoir d'eau", "Changer le joint de couvercle"] }
            ] },
            { id: "hum-sbox", name: "S.Box", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Plaque HS", "Option désactivée", "Bac entartré", "Bug logiciel"], solutionsPatient: ["Vérifier icône goutte active", "Remettre le bac fermement", "Détartrer au vinaigre blanc"], solutionsTech: ["Tester plaque chauffante", "Mise à jour firmware"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Joint arrière déformé", "Couvercle mal fermé"], solutionsPatient: ["Vérifier que le joint arrière est droit", "Clipser fermement le couvercle"], solutionsTech: ["Changer le joint de liaison interne", "Remplacer le réservoir complet"] }
            ] }
          ] },
          { id: "hum-externe", name: "Externes (autonomes)", models: [
            { id: "hc150", name: "HC150", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Résistance défectueuse", "Fusible grillé", "Thermostat activé"], solutionsPatient: ["Vérifier branchement direct", "Le voyant orange s'allume-t-il ?", "Augmenter réglage bouton", "Isoler le tuyau"], solutionsTech: ["Tester résistance (Ohms)", "Remplacer fusible thermique", "Check sonde T°"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Joint de bac usé", "Bac mal positionné", "Choc"], solutionsPatient: ["Vérifier que le bac est bien à plat", "Le joint est-il propre et souple ?", "Isoler le tuyau"], solutionsTech: ["Remplacer le joint", "Vérifier la régulation de température"] }
            ] },
            { id: "mr810-mr820", name: "MR810 / MR820", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Résistance HS", "Fusible thermique sauté", "Sonde défectueuse"], solutionsPatient: ["Voyant orange allumé ?", "L'air est-il tiède après 10 min ?", "Utiliser housse tuyau"], solutionsTech: ["Remplacer base chauffante", "Vérifier sonde T°", "Check alimentation"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Chambre mal percée", "Joint usé", "Raccords lâche"], solutionsPatient: ["L'eau coule le long du réservoir bleu ?", "Les tuyaux sont-ils bien enfoncés ?", "Serrer les raccords"], solutionsTech: ["Changer la chambre", "Vérifier l'étanchéité des raccords"] },
                { title: "Alimentation (L'appareil ne démarre pas)", causes: ["Cordon abîmé", "Surtension", "Fusible grillé"], solutionsPatient: ["La prise est-elle bien branchée ?", "Tester une autre prise murale"], solutionsTech: ["Vérifier le cordon et le fusible", "Mesurer la tension d'entrée"] }
            ] },
            { id: "my-airvo-2", name: "MY AIRVO 2", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Résistance défectueuse", "Erreur logicielle", "Pièce froide"], solutionsPatient: ["Voyez-vous message rouge ?", "Redémarrer l'appareil", "Sentez-vous l'air froid ?"], solutionsTech: ["Remplacer base chauffante", "Mise à jour firmware", "Check capteur T°"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Chambre mal insérée", "Joint usé", "Trop-plein"], solutionsPatient: ["Le réservoir est-il poussé au fond ?", "L'eau coule sous la machine ?", "Vérifier le niveau d'eau"], solutionsTech: ["Remplacer le joint de base", "Vérifier le clapet", "Changer le réservoir"] },
                { title: "Alimentation (L'appareil ne démarre pas)", causes: ["Cordon déconnecté", "Batterie HS", "Bloc défaillant"], solutionsPatient: ["La prise est-elle branchée ?", "Icône batterie visible ?", "L'appareil bipe ?"], solutionsTech: ["Vérifier le bloc externe", "Tester la tension de sortie", "Check carte alim"] }
            ] },
            { id: "vhb10a", name: "VHB10A", failures: [
                { title: "Pas de chauffage", causes: ["Résistance chauffante HS", "Résistance HS", "Sonde défectueuse", "Fil déconnecté"], solutionsPatient: ["Interrupteur sur 'I' ?", "L'air est-il trop sec ?", "Vérifier si chiffres s'allument"], solutionsTech: ["Remplacer résistance", "Vérifier fusible", "Tester sonde thermique"] },
                { title: "Fuites importantes (Bac ou Circuit)", causes: ["Raccords lâche", "Joint dégradé", "Fissure réservoir"], solutionsPatient: ["L'eau coule près des raccords ?", "Le bac est-il stable sur sa base ?", "Serrer les raccords"], solutionsTech: ["Vérifier l'étanchéité", "Resserrer les raccords", "Remplacer le joint"] },
                { title: "Alimentation (L'appareil ne démarre pas)", causes: ["Interrupteur HS", "Fusible grillé", "Cordon abîmé"], solutionsPatient: ["La prise est-elle bien branchée ?", "L'écran s'allume-t-il ?", "Tester une autre prise"], solutionsTech: ["Vérifier le cordon et le fusible", "Mesurer la tension"] }
            ] }
          ] }
        ]
      },
        ...
        subTypes: [
          {
            ...
            models: [
                { id: "b15", name: "Bouteille B15", failures: [
                    { title: "Débit faible ou irrégulier", causes: ["Bouteille vide (aiguille rouge)", "Robinet mal ouvert", "Canule pliée", "Régulateur défectueux"], solutionsPatient: ["Vérifier manomètre (zone verte)", "Ouvrir robinet à fond", "Vérifier canule"], solutionsTech: ["Tester autre manodétendeur", "Vérifier pression sortie"] },
                    { title: "Fuites importantes", causes: ["Joint O-ring manquant", "Raccord mal enclenché", "Soupape activée"], solutionsPatient: ["Sifflement au robinet ?", "Rebrancher fermement", "Fermer le robinet si fuite"], solutionsTech: ["Remplacer joint O-ring", "Test étanchéité"] },
                    { title: "Manomètre défectueux", causes: ["Choc mécanique", "Aiguille tordue", "Fuite interne mano"], solutionsPatient: ["L'aiguille bouge-t-elle quand vous ouvrez ?", "Vérifier si vitre cassée"], solutionsTech: ["Remplacer le manomètre", "Vérifier étanchéité embase"] },
                    { title: "Bruit anormal ou vibrations", causes: ["Gel interne", "Mécanisme encrassé"], solutionsPatient: ["Givre blanc sur le métal ?", "Laissez reposer 15 min"], solutionsTech: ["Nettoyer mécanisme", "Remplacer bloc régulateur"] }
                ] },
                { id: "b2", name: "Bouteille B2", failures: [
                { title: "Débit faible ou irrégulier", causes: ["Bouteille vide", "Robinet mal ouvert", "Canule pliée", "Régulateur défectueux"], solutionsPatient: ["Vérifier zone verte mano", "Ouvrir à fond", "Vérifier si le tuyau est coincé"], solutionsTech: ["Mesurer pression sortie", "Tester avec un autre manodétendeur", "Vérifier le débitmètre"] },
                { title: "Fuites importantes", causes: ["Joint usé", "Mauvais clipsage", "Soupape de sécurité active"], solutionsPatient: ["Sifflement audible ?", "Rebrancher canule fermement", "Fermer le robinet si fuite continue"], solutionsTech: ["Changer joint O-ring", "Tester l'étanchéité du bloc", "Vérifier le tarage soupape"] },
                { title: "Manomètre défectueux", causes: ["Choc", "Vitre cassée", "Fuite interne mano"], solutionsPatient: ["L'aiguille reste à zéro bouteille ouverte ?", "Vérifier si le verre est fendu"], solutionsTech: ["Remplacer manomètre", "Vérifier l'étanchéité de l'embase"] }
                ] },
                { id: "b5", name: "Bouteille B5", failures: [
                { title: "Débit faible ou irrégulier", causes: ["Bouteille vide", "Canule pliée", "Robinet mal ouvert", "Régulateur encrassé"], solutionsPatient: ["Vérifier aiguille mano", "Vérifier le trajet du tuyau", "Ouvrir le robinet au maximum"], solutionsTech: ["Contrôler débitmètre", "Nettoyer le raccord de sortie", "Vérifier la pression de service"] },
                { title: "Fuites importantes", causes: ["Joint défectueux", "Sifflement", "Raccord mal enclenché"], solutionsPatient: ["Vérifier joint au raccord", "Serrer détendeur", "Rebrancher la canule"], solutionsTech: ["Remplacer joint O-ring", "Test étanchéité sous pression"] },
                { title: "Manomètre défectueux", causes: ["Choc", "Aiguille bloquée", "Vitre cassée"], solutionsPatient: ["L'aiguille bouge-t-elle à l'ouverture ?", "Vérifier l'état extérieur"], solutionsTech: ["Changer manomètre", "Vérifier étanchéité embase"] }
                ] },
                { id: "oxalys", name: "Oxalys", failures: [
                { title: "Débit faible ou irrégulier", causes: ["Bouteille vide", "Sélecteur cassé", "Canule obstruée"], solutionsPatient: ["Vérifier mano (zone verte)", "Tourner fermement le bouton de débit", "Essayer une canule neuve"], solutionsTech: ["Vérifier l'axe du sélecteur", "Mesurer le débit réel en sortie", "Remplacer le bloc régulateur"] },
                { title: "Fuites importantes", causes: ["Joint valve usé", "Raccord rapide fuyard", "Sifflement interne"], solutionsPatient: ["Entendez-vous un pshhh au niveau du bloc ?", "Rebrancher la canule"], solutionsTech: ["Changer le joint à lèvres", "Tester l'étanchéité du bloc complet"] },
                { title: "Manomètre défectueux", causes: ["Choc", "Aiguille tordue"], solutionsPatient: ["Aiguille sur zéro malgré la bouteille pleine ?", "Vérifier si le cadran est lisible"], solutionsTech: ["Remplacer le manomètre intégré", "Calibrer le ressort"] }
                ] },
        ...
        name: "Concentrateurs",
            subTypes: [
              {
                ...
                models: [
                  ...
                  { title: "Fuites importantes", causes: ["Défaut compresseur", "Fuite interne sur les tubulures", "Vanne 4 voies bloquée"], solutionsPatient: ["L'appareil fait-il un sifflement anormal ?", "Vérifiez que la canule n'est pas coincée."], solutionsTech: ["Maintenance technique (compresseur).", "Recherche de fuites pneumatiques.", "Vérifier le cycle des vannes."] },
                  { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Ventilateur desserré"], solutionsPatient: ["L'appareil fait-il un bruit de claquement ?", "Vérifiez si l'appareil est bien à plat sur le sol."], solutionsTech: ["Maintenance moteur.", "Remplacer les fixations moteur.", "Vérifier les pales du ventilateur."] },
                        { title: "Erreur Système (Panne Interne)", causes: ["Compresseur en fin de vie", "Capteur de pureté HS", "Défaut carte électronique", "Surchauffe moteur", "Pile d'alarme HS"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur sur l'écran ?", "Redémarrer l'appareil après 15 min d'arrêt"], solutionsTech: ["Effectuer un diagnostic logiciel.", "Mesurer la tension de la carte.", "Vérifier les balais du moteur.", "Remplacer le bloc compresseur.", "Changer la pile 9V si applicable."] },
                    ...
                    { id: "525ks", name: "5L (525KS)", failures: [
                        ...
                        { title: "Fuites importantes", causes: ["Défaut compresseur", "Fuite interne sur les tubulures", "Vanne 4 voies bloquée"], solutionsPatient: ["L'appareil fait-il un sifflement anormal ?", "Vérifiez que la canule n'est pas coincée."], solutionsTech: ["Maintenance technique (compresseur).", "Recherche de fuites pneumatiques.", "Vérifier le cycle des vannes."] },
                    { title: "Erreur Système (Panne Interne)", causes: ["Capteurs HS", "Panne interne", "Fuite pneumatique", "Surchauffe", "Tamis moléculaires fatigués"], solutionsPatient: ["L'appareil s'arrête-t-il tout seul sans raison apparente ?", "Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Vérifiez la température de la pièce et le filtre arrière."], solutionsTech: ["Remplacer capteurs.", "Effectuer test d'étanchéité", "Vérifier ventilateur", "Maintenance technique / SAV."] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                    ] },
                ...
                { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                    ...
                    { title: "Erreur Système( Panne Interne)", causes: ["Panne interne", "Carte électronique HS", "Capteur O2 défectueux"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur sur l'écran ?", "Vérifiez l'état de la prise murale."], solutionsTech: ["Maintenance technique / SAV.", "Vérifier tensions carte", "Remplacer capteur O2"] },
                    , { title: "Faible concentration d’oxygène", causes: ["Usure"], solutionsPatient: ["-"], solutionsTech: ["Analyser O2"] },
                    { title: "Alarme pureté", causes: ["Capteur"], solutionsPatient: ["-"], solutionsTech: ["Changer O2 cell"] },
                    { title: "Filtre encrassé", causes: ["Filtre feutre"], solutionsPatient: ["Nettoyer"], solutionsTech: ["Changer"] },
                    { title: "Compresseur HS", causes: ["Piston"], solutionsPatient: ["Bruit"], solutionsTech: ["SAV"] }
                    ...
                    { title: "Erreur Système( Panne Interne)", causes: ["Panne interne", "Défaut carte", "Surchauffe", "Vanne 4 voies bloquée"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur sur l'écran ?", "Vérifiez que l'appareil est branché seul sur la prise."], solutionsTech: ["Maintenance technique / SAV.", "Check carte", "Nettoyer ouïes", "Vérifier les tensions."] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                 ] },
                    ...
                    { title: "Fuites importantes", causes: ["Défaut compresseur", "Fuite interne sur les tubulures", "Vanne 4 voies bloquée"], solutionsPatient: ["L'appareil fait-il un sifflement anormal ?", "Vérifiez que la canule n'est pas coincée."], solutionsTech: ["Maintenance technique (compresseur).", "Recherche de fuites pneumatiques.", "Vérifier le cycle des vannes."] },
                        { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Usure des tamis moléculaires", "Filtre d'entrée poussiéreux", "Fuite interne"], solutionsPatient: ["Est-ce que vous voyez un voyant de couleur jaune ou rouge allumé ?", "Le filtre noir sur le côté de l'appareil vous semble-t-il propre ?"], solutionsTech: ["Mesurer la pureté à l'analyseur.", "Effectuer un test de fuite.", "Remplacer les colonnes de tamis."] },
                    { title: "Fuites importantes", causes: ["Bocal mal vissé", "Joint du couvercle usé ou absent", "Tuyau d'oxygène mal connecté", "Couvercle de travers", "Raccord cassé"], solutionsPatient: ["Est-ce que vous entendez un sifflement persistant ?", "Avez-vous essayé de dévisser puis de revisser bien droit le couvercle du bocal ?", "Serrer le tuyau à la main", "Vérifier le joint blanc"], solutionsTech: ["Contrôler l'état du joint du bocal.", "Vérifier le raccord de sortie d'O2.", "Tester étanchéité interne", "Changer le bocal"] },
                    ...
                    { title: "Erreur Système (Surchauffe / Ventilation)", causes: ["Ventilation obstruée", "Température ambiante trop élevée", "Ventilateur interne bloqué"], solutionsPatient: ["Est-ce que l'appareil est collé contre un mur ou un rideau ?", "Fait-il très chaud dans votre chambre ?"], solutionsTech: ["Nettoyer les ouïes de ventilation.", "Vérifier le fonctionnement du ventilateur.", "Maintenance préventive."] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                   ] },
                    { id: "homefill", name: "Invacare HomeFill (Compresseur)", failures: [
                        { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur", "Fusible interne", "Surchauffe"], solutionsPatient: ["La prise est-elle bien branchée ?", "L'appareil est-il chaud ?", "Appuyez sur l'interrupteur Marche/Arrêt."], solutionsTech: ["Vérifier fusible.", "Contrôler tension carte."] },
                        { title: "Erreur Système (Débit trop élevé / Couplage)", causes: ["Débit du concentrateur compagnon supérieur à 3 L/min"], solutionsPatient: ["Réduisez le débit du concentrateur (celui qui est à côté du compresseur).", "Attendez que le voyant repasse au vert."], solutionsTech: ["Vérifier la pression de couplage."] },
                        { title: "Erreur Système (Bouteille mal enclenchée)", causes: ["Bouteille mal positionnée", "Joint de l'embase sale", "Compresseur fatigué"], solutionsPatient: ["Retirez et remettez la bouteille jusqu'au 'double clic'.", "Nettoyez le connecteur avec un chiffon propre et sec."], solutionsTech: ["Remplacer le joint de l'embase.", "Vérifier le débit de remplissage."] },
                    { title: "Fuites importantes", causes: ["Mauvaise connexion", "Joint sale", "O-ring bouteille absent", "Choc sur embase"], solutionsPatient: ["Nettoyez le connecteur avec un chiffon sec.", "Reconnectez fermement la bouteille jusqu'au clic.", "Essuyer la valve bouteille", "Vérifier le joint noir"], solutionsTech: ["Remplacer le joint de l'embase.", "Vérifier alignement port", "Tester avec bouteille neuve", "Check étanchéité interne"] },
                        { title: "Problème de remplissage lent", causes: ["Compresseur fatigué", "Fuite interne", "Bouteille HS"], solutionsPatient: ["Vérifiez que la bouteille ne siffle pas.", "Nettoyez le raccord."], solutionsTech: ["Mesurer le débit de remplissage.", "Tester avec une bouteille neuve."] },
                        { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable"], solutionsPatient: ["L'appareil est-il bien à plat ?", "Le bruit s'arrête-t-il si vous bougez la bouteille ?"], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs."] }
                    , { title: "Faible concentration d’oxygène", causes: ["Alim O2", "O2 concentrateur < 90%", "Fuite tuyau liaison", "Pollution"], solutionsPatient: ["Check concentrateur", "Vérifier le tuyau gris", "Aérer la pièce", "Nettoyer filtres"], solutionsTech: ["Check pureté entrée", "Vérifier tamis internes", "Mesurer P. remplissage", "Recalibrer capteur"] },
                    { title: "Alarme pureté", causes: ["O2 Bas", "Humidité", "Capteur HS", "Vanne fatiguée"], solutionsPatient: ["Vérifier concentrateur", "Attendre 5min", "Aérer", "Vérifier canule"], solutionsTech: ["Recalibrer", "SAV", "Changer capteur", "Tester vannes"] },
                    { title: "Filtre encrassé", causes: ["Poussière", "Tabac", "Usage intense", "Poils animaux"], solutionsPatient: ["Check filtre", "Nettoyer grille", "Passer aspirateur", "Changer filtre externe"], solutionsTech: ["Changer HEPA interne", "Nettoyage turbine", "Dépoussiérage carte", "Check flux air"] },
                        { title: "Compresseur HS", causes: ["Fatigue"], solutionsPatient: ["Bruit fort"], solutionsTech: ["Changer moteur"] }
                        ]},
                    { id: "ultrafill", name: "UltraFill", failures: [
                    { title: "Erreur Système", causes: ["Panne interne", "Capteur O2 HS", "Défaut carte"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur sur l'écran ?"], solutionsTech: ["Maintenance technique / SAV.", "Remplacer capteur", "Vérifier tensions"] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                    , { title: "Faible concentration d’oxygène", causes: ["Entrée", "Tamis saturés", "Fuite", "Humidité"], solutionsPatient: ["Check O2 machine", "Vérifier raccords", "Laisser reposer", "Aérer"], solutionsTech: ["Analyser pureté", "Check tamis", "Check P1", "Reset"] },
                    { title: "Alarme pureté", causes: ["O2 Bas", "Capteur HS", "Pollution", "Débit"], solutionsPatient: ["Check voyant", "Aérer", "Vérifier machine", "Reset"], solutionsTech: ["Calibration", "SAV", "Check valve", "Test O2"] },
                    { title: "Filtre encrassé", causes: ["Poussière", "Cheveux", "Humidité", "Usage"], solutionsPatient: ["Check filtre", "Nettoyer", "Aspirer grille", "Changer externe"], solutionsTech: ["Changer HEPA", "Check fan", "Nettoyage interne", "Vérifier débit"] },
                    { title: "Compresseur HS", causes: ["Nombre d'heures"], solutionsPatient: ["Bruit"], solutionsTech: ["SAV"] }
                   ] },
                    { id: "igo2-fixe", name: "iGo 2 (Mode Fixe)", failures: [
                        ...
                        { title: "Fuites importantes", causes: ["Défaut compresseur", "Fuite interne sur les tubulures", "Vanne 4 voies bloquée"], solutionsPatient: ["L'appareil fait-il un sifflement anormal ?", "Vérifiez que la canule n'est pas coincée."], solutionsTech: ["Maintenance technique (compresseur).", "Recherche de fuites pneumatiques.", "Vérifier le cycle des vannes."] },
                    { title: "Erreur Système", causes: ["Panne interne", "Défaut carte", "Surchauffe", "Tamis moléculaires HS"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur sur l'écran ?", "Laissez l'appareil éteint 30 min et redémarrez."], solutionsTech: ["Maintenance technique / SAV.", "Check carte.", "Contrôler tensions.", "Remplacer les colonnes."] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                    , { title: "Faible concentration d’oxygène", causes: ["Saturation des tamis", "Fuite interne", "Compresseur fatigué", "Humidité tamis"], solutionsPatient: ["Vérifier l'aération", "Dégager le sac", "Nettoyer pré-filtre", "Tester sans humidificateur"], solutionsTech: ["Analyser la pureté O2", "Test d'étanchéité", "Changer colonnes", "Mesurer pression P1"] },
                    { title: "Alarme pureté", causes: ["Tamis usés", "Capteur O2 HS", "Entrée air bouchée"], solutionsPatient: ["Aérer", "Nettoyer les filtres", "Redémarrer l'appareil"], solutionsTech: ["Remplacer tamis", "Recalibrer capteur", "Tester compresseur"] },
                    { title: "Filtre encrassé", causes: ["Usage intensif", "Poussière", "Poils animaux"], solutionsPatient: ["Nettoyer le filtre", "Passer aspirateur sur grilles", "Laver à l'eau (si lavable)"], solutionsTech: ["Remplacer pré-filtre", "Nettoyage interne", "Vérifier débit turbine"] },
                    { title: "Compresseur HS", causes: ["Moteur défectueux", "Charbons usés", "Bielle cassée"], solutionsPatient: ["Pas de débit malgré le bruit", "Vibrations fortes", "Odeur de chaud"], solutionsTech: ["Remplacer le compresseur", "Vérifier condensateur", "Mesurer courant"] }
                   ] }
                ]
              },
              {
                ...
                models: [
                    { id: "inogen-g3", name: "Inogen One G3", failures: [
                        ...
                        { title: "Problème de batterie ou autonomie", causes: ["Batterie mal enclenchée", "Contacts sales", "Batterie fin de vie", "Surchauffe batterie", "Batterie ne charge plus", "Alarme batterie"], solutionsPatient: ["Avez-vous entendu le 'clic' ?", "Les contacts en métal sont-ils propres ?", "La batterie est-elle très chaude ?", "Vérifier voyant de charge", "Tester sans batterie", "Nettoyer port"], solutionsTech: ["Contrôler la capacité de la batterie.", "Nettoyer les connecteurs.", "Remplacer la batterie.", "Vérifier carte de charge", "Check chargeur DC"] },
                        { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] },
                    { title: "Problème d'affichage", causes: ["Bug tactile", "Nappe déconnectée"], solutionsPatient: ["Essuyer l'écran", "Débrancher 30 sec"], solutionsTech: ["Changer bloc écran"] },
                        { title: "Défaut de capteur", causes: ["Humidité", "Pression support", "Capteur P1 HS", "Trigger HS"], solutionsPatient: ["Vérifier canule", "Reset appareil", "Changer canule", "Laisser sécher"], solutionsTech: ["Vérifier vannes", "Changer capteur P", "Calibration", "Check carte"] }
                    ] },
                    { id: "inogen-g4", name: "Inogen One G4", failures: [
                        ...
                        { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Tamis (colonnes) usés", "Filtres à particules sales", "Fuite interne"], solutionsPatient: ["Est-ce que les deux filtres sur les côtés sont propres ?", "L'appareil est-il bien aéré dans son sac ?"], solutionsTech: ["Mesurer la pureté O2.", "Remplacer les colonnes.", "Vérifier l'étanchéité pneumatique."] },
                ...
                { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] }
                    ...
                    { title: "Erreur Système", causes: ["Panne interne", "Tamis en fin de vie", "Pile interne vide", "Capteur O2 HS"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur spécifique ?", "Redémarrer l'appareil après 10 min."], solutionsTech: ["Maintenance technique / SAV.", "Remplacement des colonnes.", "Diagnostic via logiciel constructeur."] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] },
                { title: "Batterie ne charge plus", causes: ["Cellules usées", "Contacts oxydés", "Défaut contrôleur de charge"], solutionsPatient: ["Nettoyer les contacts avec un chiffon sec", "Vérifier le branchement du bloc secteur"], solutionsTech: ["Tester la tension de charge aux bornes", "Remplacer la batterie", "Vérifier le circuit de charge interne"] },
                { title: "Débit insuffisant ou O2 Bas", causes: ["Fuite pneumatique", "Saturation des tamis", "Compresseur fatigué"], solutionsPatient: ["Vérifier le raccord de la canule", "Aérer la pièce"], solutionsTech: ["Mesurer la pureté à l'analyseur", "Tester l'étanchéité du circuit interne", "Remplacer les colonnes"] },
                { title: "Alarme batterie (Basse/Erreur)", causes: ["Décharge profonde", "Défaut communication SMBus"], solutionsPatient: ["Laisser branché 4h sans interruption", "Retirer et remettre la batterie"], solutionsTech: ["Tester la capacité réelle", "Vérifier les picots du connecteur batterie"] },
                { title: "Problème d'affichage (Ecran figé/éteint)", causes: ["Bug logiciel", "Nappe LCD desserrée", "Humidité"], solutionsPatient: ["Redémarrer l'appareil", "Éviter l'exposition au soleil"], solutionsTech: ["Vérifier la connexion de la nappe", "Mise à jour firmware", "Remplacer l'afficheur"] },
                { title: "Surchauffe de l'appareil", causes: ["Obstruction airflow", "Filtres encrassés", "Ventilateur HS"], solutionsPatient: ["Sortir l'appareil du sac de transport", "Laisser refroidir 30 min", "Nettoyer les filtres extérieurs"], solutionsTech: ["Nettoyage interne à l'air sec", "Vérifier le fonctionnement du ventilateur"] },
                { title: "Défaut de capteur (Pression/O2)", causes: ["Capteur décalibré", "Vanne de pulsion bloquée"], solutionsPatient: ["Redémarrer l'appareil", "Changer de canule"], solutionsTech: ["Recalibrer les capteurs via logiciel", "Tester le cycle des vannes"] }
                    ] },
    ...
    
              {
                ...
                models: [
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Saturation des tamis moléculaires", "Filtre d'entrée colmaté", "Fuite interne", "Humidité excessive"], solutionsPatient: ["Vérifiez que le filtre à poussière à l'arrière est propre.", "Placez l'appareil dans un endroit bien aéré.", "Assurez-vous de ne pas être trop près d'une source de vapeur.", "Aérez la pièce."], solutionsTech: ["Mesurer la pureté O2 avec un analyseur.", "Remplacer les colonnes de tamis.", "Vérifier la pression du compresseur.", "Contrôler l'étanchéité pneumatique."] },
                    ...
                    { title: "Débit irrégulier", causes: ["Vanne directionnelle"], solutionsPatient: ["-"], solutionsTech: ["Maintenance interne"] },
        
                        { title: "Débit faible ou irrégulier", causes: ["Canule pliée ou écrasée", "Filtre HEPA bouché", "Vanne de sortie bloquée", "Bocal humidificateur fuyard", "Vanne directionnelle"], solutionsPatient: ["Vérifiez que votre canule n'est pas pliée.", "Essayez avec une canule neuve.", "Si vous utilisez un humidificateur, vérifiez qu'il est bien fermé.", "Sentez-vous l'air sortir au bout ?"], solutionsTech: ["Vérifier le capteur de débit.", "Remplacer le filtre HEPA de sortie.", "Tester la pression de sortie.", "Vérifier le cycle de la vanne de pulsion.", "Maintenance interne"] },
                        { title: "Surchauffe / Ventilation", causes: ["Ventilation obstruée", "Ventilateur interne HS", "Environnement trop chaud", "Filtres internes encrassés"], solutionsPatient: ["Sortez l'appareil de sa sacoche.", "Vérifiez que les grilles sont libres.", "Laissez refroidir l'appareil 30 minutes.", "Éloignez l'appareil du soleil."], solutionsTech: ["Vérifier le ventilateur interne.", "Nettoyage interne à l'air sec.", "Contrôler la température de la turbine via le menu service."] },
                        ...
                        { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] },
                        { title: "Châssis / Roues / Poignée", causes: ["Usage", "Choc"], solutionsPatient: ["Difficile à déplacer"], solutionsTech: ["Réparer chariot"] }
                ]},
                  ...
                  { title: "Erreur Système (O2 Bas / Pureté)", causes: ["Saturation des tamis moléculaires", "Filtre d'entrée colmaté", "Fuite interne", "Humidité excessive"], solutionsPatient: ["Vérifiez que le filtre à poussière à l'arrière est propre.", "Placez l'appareil dans un endroit bien aéré.", "Assurez-vous de ne pas être trop près d'une source de vapeur.", "Aérez la pièce."], solutionsTech: ["Mesurer la pureté O2 avec un analyseur.", "Remplacer les colonnes de tamis.", "Vérifier la pression du compresseur.", "Contrôler l'étanchéité pneumatique."] },        
                        ...
                        { title: "Problème de détection respiratoire (Trigger)", causes: ["Respiration par la bouche", "Canule trop longue (> 2.1m)", "Sensibilité trigger basse", "Valve de pulsion bloquée"], solutionsPatient: ["Respirez bien par le nez.", "Utilisez une canule de 2 mètres maximum.", "Vérifiez le branchement du tuyau.", "Testez en mode continu."], solutionsTech: ["Recalibrer la sensibilité du trigger.", "Tester la valve pneumatique.", "Vérifier l'étanchéité du circuit."] },
                        { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] },
                        { title: "Châssis / Roues / Poignée", causes: ["Usage intensif", "Choc", "Sable ou sel dans les axes", "Poignée bloquée"], solutionsPatient: ["Vérifier l'état des roues", "La poignée coulisse-t-elle bien ?", "Nettoyer les axes avec un chiffon humide"], solutionsTech: ["Changer le chariot de transport", "Graisser les axes", "Remplacer la poignée télescopique"] }
                ]},
                    ...
                    { title: "Erreur Système (Codes Alarme / Panne)", causes: ["Défaut carte mère", "Cycle de vanne irrégulier", "Capteur HS"], solutionsPatient: ["L'appareil s'arrête-t-il seul ?", "Le voyant rouge est-il allumé ?", "Débrancher et rebrancher après 5 min."], solutionsTech: ["Remplacer capteurs.", "Vérifier tensions carte.", "Maintenance SAV.", "Vérifier cycle des vannes."] },
                    { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable"], solutionsPatient: ["L'appareil est-il bien à plat ?", "Vérifier qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur."] },
                   { title: "Problème de batterie ou autonomie", causes: ["Batterie en fin de vie", "Surchauffe batterie"], solutionsPatient: ["Branchez sur secteur immédiatement.", "Laissez la batterie refroidir si elle est chaude."], solutionsTech: ["Vérifier la capacité de charge.", "Remplacer la batterie."] },
                    { title: "Châssis / Roues / Poignée", causes: ["Choc", "Usage intensif", "Sable dans les axes"], solutionsPatient: ["Vérifier l'état des roues.", "La poignée coulisse-t-elle bien ?"], solutionsTech: ["Changer le chariot.", "Graissage des axes.", "Remplacer la poignée."] },
                    { title: "Connectique défectueuse", causes: ["Port d'alimentation lâche", "Poussière dans la fiche"], solutionsPatient: ["Vérifier si le cordon bouge dans la prise.", "Nettoyer le port de charge."], solutionsTech: ["Ressouder l'embase DC.", "Remplacer le cordon d'alimentation."] },
                      ] },
                ...
                { title: "Problème d'affichage", causes: ["Usure", "Humidité", "Nappe", "Bug"], solutionsPatient: ["-", "Essuyer écran", "Reset alim", "A l'ombre"], solutionsTech: ["Changer", "SAV", "Mise à jour", "Nettoyage nappe"] },
                { title: "Défaut de capteur", causes: ["Interne", "Pression", "O2", "Trigger"], solutionsPatient: ["SAV", "Reset", "Aérer", "Vérifier canule"], solutionsTech: ["-", "Calibration", "Check vannes", "SAV"] },
                        { title: "Surchauffe / Ventilation", causes: ["Environnement", "Ventilo", "Sac", "Filtre"], solutionsPatient: ["Dégager", "Sortir du sac", "Aérer", "Éteindre"], solutionsTech: ["Vérifier fan", "Nettoyage interne", "SAV"] },
                    ] },
                    { id: "zen-o", name: "Zen-O", failures: [
                        ...
                        { title: "Erreur Système", causes: ["Panne interne", "Défaut carte", "Surchauffe", "Vanne 4 voies bloquée"], solutionsPatient: ["Le voyant rouge est-il allumé et l'appareil bipe-t-il ?", "Y a-t-il un message d'erreur sur l'écran ?", "Vérifiez que l'appareil est branché seul sur la prise."], solutionsTech: ["Maintenance technique / SAV.", "Check carte", "Nettoyer ouïes", "Vérifier les tensions."] },
                        { title: "Bruit anormal ou vibrations", causes: ["Compresseur fatigué", "Silentblocs usés", "Position instable", "Composant interne desserré"], solutionsPatient: ["L'appareil est-il bien à plat sur une surface stable ?", "Le bruit change-t-il si vous le déplacez ?", "Vérifiez qu'aucun objet ne vibre contre le boîtier."], solutionsTech: ["Vérifier les fixations moteur.", "Remplacer les silentblocs.", "Vérifier le ventilateur.", "Resserrer le châssis."] },
                    
                    { title: "Problème d'affichage", causes: ["Usure", "Nappe", "Humidité", "Carte"], solutionsPatient: ["-", "Essuyer", "Redémarrer", "A l'ombre"], solutionsTech: ["Changer bloc", "SAV", "Nettoyer nappe", "MAJ"] },
                    { title: "Défaut de capteur", causes: ["Interne", "Pression", "O2", "Trigger"], solutionsPatient: ["SAV", "Reset", "Check canule", "-"], solutionsTech: ["SAV", "Calibration", "Check vannes", "Check carte"] },
                        { title: "Surchauffe / Ventilation", causes: ["Sac", "Filtre", "Ventilo", "Ambiante"], solutionsPatient: ["Sortir sac", "Dégager grilles", "Éteindre", "Aérer"], solutionsTech: ["Check fan", "Nettoyage interne", "SAV"] },
                    ] }
                ]
              },
            ]
          ...
          { 
            ...
            models: [
                ...
                { title: "Erreur Système", causes: ["Pile 9V interne épuisée", "Capteur de pression différentielle HS", "Flotteur bloqué par la glace"], solutionsPatient: ["L'indicateur reste-t-il noir quand vous appuyez sur le bouton ?", "Avez-vous bien rempli l'appareil jusqu'au 'crachement' ?", "Secouez doucement l'appareil, entendez-vous le liquide bouger ?"], solutionsTech: ["Remplacer la pile 9V.", "Vérifier la tension aux bornes du capteur.", "Dégivrer complètement l'unité pour libérer le flotteur.", "Calibrer l'affichage du niveau via les potentiomètres."] }
                ] },
                { id: "companion-t", name: "Companion 1000T", failures: [
                { title: "Fuites importantes", causes: ["Soupape de sécurité active", "Fuite au joint de remplissage", "Pression interne trop élevée", "Choc sur l'embase"], solutionsPatient: ["Entendez-vous un sifflement même quand vous ne l'utilisez pas ?", "Y a-t-il de la glace sur le connecteur de remplissage ?", "L'appareil a-t-il subi une chute récemment ?"], solutionsTech: ["Vérifier la pression de tarage de la soupape.", "Remplacer le joint à lèvres du connecteur mâle.", "Contrôler le vide du vase Dewar.", "Nettoyer les portées de joint à l'alcool."] },
                { title: "Pas de débit d'oxygène", causes: ["Valve de sortie gelée", "Sélecteur de débit cassé", "Canule obstruée"], solutionsPatient: ["Vérifier la présence de givre blanc sur le haut", "Laisser l'appareil se réchauffer 30 min", "Essayer une canule neuve"], solutionsTech: ["Décongeler l'unité", "Vérifier l'axe du sélecteur", "Mesurer le débit de sortie"] },
                    { title: "Pas de débit d'oxygène", causes: ["Valve de sortie gelée", "Sélecteur de débit cassé", "Canule obstruée"], solutionsPatient: ["Vérifier la présence de givre blanc sur le haut", "Laisser l'appareil se réchauffer 30 min", "Essayer une canule neuve"], solutionsTech: ["Décongeler l'unité", "Vérifier l'axe du sélecteur", "Mesurer le débit de sortie"] },
                    { title: "Fuites importantes", causes: ["Soupape de sécurité active", "Fuite au joint de remplissage", "Pression interne trop élevée", "Choc sur l'embase"], solutionsPatient: ["Entendez-vous un sifflement même quand vous ne l'utilisez pas ?", "Y a-t-il de la glace sur le connecteur ?", "L'appareil a-t-il subi une chute récemment ?"], solutionsTech: ["Vérifier la pression de tarage de la soupape.", "Remplacer le joint à lèvres du connecteur mâle.", "Contrôler le vide du vase Dewar.", "Nettoyer les portées de joint à l'alcool."] }
            ] },
                ...
                { title: "Fuites importantes", causes: ["Joint usé"], solutionsPatient: ["Voyez-vous du liquide couler ?"], solutionsTech: ["Vérifier et remplacer joint."] },
                    ...
                    { title: "Fuites importantes", causes: ["Joint usé", "Soupape de sécurité active", "Choc sur l'embase", "Glace sur connecteur"], solutionsPatient: ["Voyez-vous du liquide couler ?", "Entendez-vous un pshhh continu ?", "Rebrancher brièvement sur la cuve pour dégeler la valve"], solutionsTech: ["Vérifier et remplacer le joint à lèvres.", "Vérifier la pression de service.", "Tester la soupape de sécurité.", "Nettoyer les portées de joint."] },
                    { title: "Faible autonomie", causes: ["Remplissage incorrect", "Perte de vide (vase Dewar)", "Fuite soupape", "Évaporation excessive"], solutionsPatient: ["Remplissez-vous bien jusqu'à saturation (crachement) ?", "Vérifier si le boîtier extérieur est anormalement froid"], solutionsTech: ["Former l'utilisateur au remplissage.", "Contrôler le vide interne.", "Remplacer la soupape si elle fuit à basse pression."] },
                    { title: "Givre important", causes: ["Utilisation continue à des débits élevés", "Humidité ambiante élevée", "Fuite interne"], solutionsPatient: ["Essuyez le boîtier avec un chiffon sec.", "Laissez l'appareil au repos 1 heure.", "Éloignez l'appareil d'une source d'humidité."], solutionsTech: ["Vérifier l'isolation du vase Dewar.", "Contrôler l'étanchéité des raccords internes."] },
                ...
                { title: "Fuites importantes", causes: ["Joint usé"], solutionsPatient: ["Voyez-vous du liquide couler ?"], solutionsTech: ["Vérifier et remplacer joint."] },
                    { title: "Faible autonomie", causes: ["Remplissage incorrect"], solutionsPatient: ["Remplissez-vous bien jusqu'à saturation (crachement) ?"], solutionsTech: ["Former utilisateur.", "Corriger remplissage."] },
                    { title: "Fuites importantes", causes: ["Joint de valve usé", "Givre bloquant la fermeture", "Soupape active"], solutionsPatient: ["Voyez-vous du liquide couler ?", "Entendez-vous un sifflement ?", "Vérifier si du givre bloque le connecteur"], solutionsTech: ["Remplacer le joint à lèvres.", "Vérifier la valve de remplissage.", "Contrôler la pression de tête."] },
                    { title: "Faible autonomie", causes: ["Remplissage incomplet", "Vase Dewar défectueux (perte de vide)", "Fuite soupape"], solutionsPatient: ["Remplissez-vous bien jusqu'au crachement ?", "Vérifier si de la buée se forme sur le boîtier"], solutionsTech: ["Vérifier le vide interne.", "Tester la soupape de sécurité.", "Mesurer le taux d'évaporation sur 24h."] }
                ] },
                { id: "freelox-05", name: "Freelox 0.5L", failures: [
                    ...
                    { title: "Pas de débit / Blocage de vapeur", causes: ["Tube de vapeur bouché", "Valve de sortie gelée", "Sélecteur défectueux"], solutionsPatient: ["Le tube est-il plié ?", "Voyez-vous du givre sur le haut ?", "Vérifiez le niveau."], solutionsTech: ["Nettoyage tube de vapeur.", "Décongélation.", "Vérifier l'axe du bouton."] },
                    { title: "Le réservoir portable ne se remplit pas", causes: ["Valve de remplissage gelée", "Mauvaise connexion sur la cuve", "Joint de valve usé"], solutionsPatient: ["Vérifiez la connexion.", "Si du givre bloque, attendez le dégel naturel.", "Essuyez les connecteurs."], solutionsTech: ["Vérifier la valve de remplissage.", "Remplacer le joint à lèvres.", "Sécher les valves à l'air sec."] }
                ] },
                { id: "freelox-12", name: "Freelox 1.2L", failures: [
                    ...
                    { title: "Pas de débit / Blocage de vapeur", causes: ["Tube de vapeur bouché", "Sélecteur cassé", "Valve gelée"], solutionsPatient: ["Le tube est-il plié ?", "Laissez réchauffer si givre blanc.", "Vérifiez la canule."], solutionsTech: ["Nettoyage tube de vapeur.", "Vérifier l'axe du sélecteur.", "Décongélation."] },
                    { title: "Le réservoir portable ne se remplit pas", causes: ["Valve gelée", "Mauvaise connexion", "Joint à lèvres HS"], solutionsPatient: ["Vérifiez la connexion.", "Attendez le dégel naturel.", "Nettoyez les valves."], solutionsTech: ["Vérifier la valve.", "Remplacer le joint.", "Sécher à l'air sec."] }
                ] },
                { id: "joggy", name: "Joggy", failures: [
                    ...
                    { title: "Pas de débit ", causes: ["Tube de vapeur bouché", "Valve de sortie gelée", "Canule obstruée"], solutionsPatient: ["Le tube est-il plié ?", "Vérifiez s'il reste du liquide.", "Essayez une autre canule."], solutionsTech: ["Nettoyage tube de vapeur.", "Décongélation.", "Vérifier le limiteur de débit."] },
                    { title: "Le réservoir portable ne se remplit pas", causes: ["Valve gelée", "Raccord mal enclenché", "Joint usé"], solutionsPatient: ["Vérifiez la connexion.", "Laissez dégeler si besoin.", "Nettoyez les embouts."], solutionsTech: ["Vérifier la valve.", "Remplacer le joint.", "Check ressort de rappel."] }
                ] },
                { id: "helios-h300", name: "Helios H300", failures: [
                { title: "Bruit anormal ou vibrations", causes: ["Pompe usée", "Bulles dans liquide"], solutionsPatient: ["Entendez-vous un bruit irrégulier ?"], solutionsTech: ["Remplacer pompe.", "Purger système."] },
                ...
                { title: "Fuites importantes", causes: ["Joint détérioré"], solutionsPatient: ["Entendez-vous une fuite continue ?"], solutionsTech: ["Remplacer joint."] },
                    ...
                    { title: "Fuites importantes", causes: ["Joint détérioré", "Fuite d'oxygène à l'embase", "Givre sur le connecteur"], solutionsPatient: ["Entendez-vous une fuite continue ?", "Essuyez bien l'embase avant de remplir le portable.", "Voyez-vous un nuage blanc sortir de la cuve sans le portable ?"], solutionsTech: ["Remplacer joint.", "Remplacer le joint à lèvres de l'embase.", "Vérifier la valve de transfert."] }
                ] },
                ...
                { title: "Fuite de vapeur ou sifflement (Soupape)", causes: ["Surcharge de cuve", "Évaporation normale", "Perte de vide du vase Dewar"], solutionsPatient: ["L'alarme sonne-t-elle ?", "Utilisez-vous l'appareil quotidiennement ?"], solutionsTech: ["Respecter capacité max.", "Contrôler la pression de service.", "Vérifier le vide interne."] },
                    { title: "Fuite de vapeur ou sifflement (Soupape)", causes: ["Surcharge de cuve", "Évaporation normale", "Perte de vide du vase Dewar"], solutionsPatient: ["L'alarme sonne-t-elle ?", "Utilisez-vous l'appareil quotidiennement ?"], solutionsTech: ["Respecter capacité max.", "Contrôler la pression de service.", "Vérifier le vide interne."] },
                ...
                { title: "Fuite de vapeur ou sifflement (Soupape)", causes: ["Surcharge de cuve", "Soupape de sécurité active", "Fuite à l'embase de remplissage"], solutionsPatient: ["L'alarme sonne-t-elle ?", "Nettoyez l'embase avec un chiffon sec."], solutionsTech: ["Respecter capacité max.", "Remplacer le joint d'embase.", "Vérifier le tarage soupape."] },
                    { title: "Fuite de vapeur ou sifflement (Soupape)", causes: ["Surcharge de cuve", "Soupape de sécurité active", "Fuite à l'embase de remplissage"], solutionsPatient: ["L'alarme sonne-t-elle ?", "Nettoyez l'embase avec un chiffon sec."], solutionsTech: ["Respecter capacité max.", "Remplacer le joint d'embase.", "Vérifier le tarage soupape."] },
                    { title: "Fuite vapeur embase", causes: ["Valve coincée", "Joint usé"], solutionsPatient: ["Le portable est-il bien retiré ?", "Vérifiez la propreté de l'embase."], solutionsTech: ["Remplacer le joint.", "Vérifier le ressort de rappel."] }
                 ]}
                ] 
    ...
    { 
        ...
        models: [
            { id: "s9", name: "S9 (AutoSet, Elite)", failures: [
                ...
                { title: "Erreur Système (Message d'erreur)", causes: ["Panne interne", "Bug logiciel"], solutionsPatient: ["Noter le code erreur", "Débrancher/rebrancher"], solutionsTech: ["Maintenance SAV", "Analyser logs"] },
                { title: "Carte SD illisible", causes: ["Mal insérée", "Verrouillage écriture"], solutionsPatient: ["Pousser la carte", "Vérifier petit loquet"], solutionsTech: ["Formater FAT32"] },
                { title: "Bruit anormal ou vibrations", causes: ["Moteur usé", "Eau dans turbine"], solutionsPatient: ["L'appareil est-il stable ?", "Vider le tuyau"], solutionsTech: ["Changer turbine", "Check silentblocs"] }
            ] },
            { id: "airsense-10", name: "S10 (AutoSet, Elite)", failures: [
                ...
                { title: "Pression insuffisante ou instable", causes: ["Filtre bouché", "Fuite massive", "Entrée d'air obstruée"], solutionsPatient: ["Remplacer le filtre", "Réajuster le masque", "Vérifier que rien ne bouche l'arrière"], solutionsTech: ["Tester turbine", "Recalibrer capteurs"] },
                { title: "Fuites importantes (Masque ou Circuit)", causes: ["Coussin usé", "Harnais lâche"], solutionsPatient: ["Silicone jauni ?", "Resserrer sangles"], solutionsTech: ["Gabarit taille", "Changer masque"] },
                ...
                { title: "Erreur Système (Message d'erreur)", causes: ["Panne interne", "Surchauffe"], solutionsPatient: ["Noter le code", "Laisser refroidir"], solutionsTech: ["SAV technique", "Check ventilateur"] },
                { title: "Carte SD illisible", causes: ["Mal insérée", "Carte HS"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater FAT32"] },
                { title: "Bruit anormal ou vibrations", causes: ["Turbine fatiguée"], solutionsPatient: ["L'appareil vibre ?"], solutionsTech: ["Changer moteur"] }
            ] },
            { id: "s11", name: "S11 (AutoSet)", failures: [
                ...
                { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Alimentation", "Connectique", "Carte HS", "Surtension"], solutionsPatient: ["La prise est-elle branchée ?", "L'écran s'allume-t-il ?", "Testez sur une autre prise ?"], solutionsTech: ["Tester bloc alim.", "Changer cordon.", "Vérifier carte.", "Contrôler fusible."] },
                { title: "Pression insuffisante ou instable", causes: ["Obstruction", "Filtre"], solutionsPatient: ["Vérifier filtre gris", "Tuyau non plié ?"], solutionsTech: ["Calibration turbine"] },
                { title: "Fuites importantes (Masque ou Circuit)", causes: ["Bac mal inséré", "Joint mal mis"], solutionsPatient: ["Clic du bac entendu ?", "Tuyau cliqué ?"], solutionsTech: ["Check étanchéité réservoir"] },
          ...
          { title: "Pression insuffisante ou instable", causes: ["Tuyau plié", "Filtre blanc colmaté", "Obstruction turbine", "Filtre noir poussiéreux"], solutionsPatient: ["Déplier le tuyau", "Le petit filtre blanc est-il noir ?", "Nettoyer le filtre en mousse bleu"], solutionsTech: ["Changer le filtre blanc.", "Vérifier le moteur.", "Check turbine"] },
          { title: "Fuites importantes (Masque ou Circuit)", causes: ["Harnais lâche", "Bac mal inséré", "Joint usé"], solutionsPatient: ["Resserrer le harnais", "Clic du bac entendu ?", "Vérifier le masque"], solutionsTech: ["Changer joint base", "Vérifier étanchéité interne"] },
          { title: "Bruit anormal ou vibrations", causes: ["Eau dans le tuyau", "Turbine fatiguée"], solutionsPatient: ["Vider le tuyau (condensation)"], solutionsTech: ["-"] },
          { title: "Carte SD illisible", causes: ["Insertion", "Formatage", "Carte HS"], solutionsPatient: ["Pousser la carte fermement"], solutionsTech: ["Formater en FAT32"] },
          { title: "Alarme ou erreur système", causes: ["Bug logiciel", "Surchauffe"], solutionsPatient: ["Reset (Débrancher/Rebrancher)"], solutionsTech: ["-"] }
            ] },
          ...
          { title: "Alarme ou Erreur Système", causes: ["Panne interne", "Défaut carte", "Batterie défectueuse", "Bug logiciel"], solutionsPatient: ["Noter le message d'erreur", "Reset (débrancher 30s)"], solutionsTech: ["Maintenance SAV", "Mise à jour (MAJ)", "Check carte"] },
          { title: "Bruit anormal ou vibrations", causes: ["Moteur/Compresseur usé", "Silentblocs", "Position instable"], solutionsPatient: ["Appareil bien à plat ?", "Rien ne vibre autour ?"], solutionsTech: ["Vérifier fixations", "Remplacer moteur"] },
          { title: "Fuites importantes (Masque ou Circuit)", causes: ["Mauvais fit", "Joint embase usé", "Bac mal inséré"], solutionsPatient: ["Ajuster le masque", "Check insertion bac"], solutionsTech: ["Remplacer joint embase"] },
          { title: "Pression insuffisante", causes: ["Filtre colmaté", "Fuite"], solutionsPatient: ["Changer le filtre"], solutionsTech: ["Check Pression (P)"] },
          { title: "Carte SD illisible", causes: ["Mal mise", "Formatage"], solutionsPatient: ["Réinsérer la carte"], solutionsTech: ["Formater"] }
            ] },
            { id: "prisma-smart", name: "Prisma (Smart, Soft)", failures: [
                              { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur", "Batterie HS", "Carte mère"], solutionsPatient: ["Brancher sur secteur", "Vérifier le voyant de charge"], solutionsTech: ["Tester l'alimentation", "Remplacer la batterie"] },

                { title: "Fuites importantes", causes: ["Fuite importante au masque", "Déconnexion"], solutionsPatient: ["Le masque bouge-t-il pendant la nuit ?", "Le tuyau est-il bien branché ?"], solutionsTech: ["Désactiver Auto-OFF.", "Ajuster le seuil de détection de fuite."] },
          { title: "Problème d'humidification (Air sec ou condensation)", causes: ["Humidité trop basse", "Bac vide", "Mauvaise insertion"], solutionsPatient: ["L'air est-il froid ?", "Reste-t-il de l'eau ?", "Pousser le bac à fond"], solutionsTech: ["Augmenter la chauffe", "Vérifier plaque", "Changer base"] },
          { title: "Pression insuffisante", causes: ["Filtre colmaté"], solutionsPatient: ["Changer le filtre"], solutionsTech: ["Check turbine"] },
          { title: "Bruit anormal ou vibrations", causes: ["Turbine usée"], solutionsPatient: ["-"], solutionsTech: ["Remplacer turbine"] },
          { title: "Carte SD illisible", causes: ["Formatage"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater"] },
          { title: "Alarme ou erreur système", causes: ["Bug logiciel"], solutionsPatient: ["Reset"], solutionsTech: ["-"] }
            ] },
          ...
          { title: "Problème d'humidification (Air sec ou condensation)", causes: ["Contacts oxydés", "Plaque HS", "Mode ECO"], solutionsPatient: ["Nettoyer les picots en métal", "Le réservoir est-il enfoncé ?"], solutionsTech: ["Nettoyer les contacts", "Tester résistance"] },
          { title: "Fuites importantes", causes: ["Age", "Mauvaise base"], solutionsPatient: ["Changer le masque", "Check clips"], solutionsTech: ["Check plaque"] },
          { title: "Pression insuffisante", causes: ["Filtre gris sale"], solutionsPatient: ["Changer le filtre"], solutionsTech: ["Calibration"] },
          { title: "Alarme ou erreur système", causes: ["Défaut électronique"], solutionsPatient: ["Reset"], solutionsTech: ["SAV"] },
          { title: "Carte SD illisible", causes: ["Formatage"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater"] }
            ] },
          ...
          { title: "Pression insuffisante ou instable", causes: ["Altitude", "Moteur fatigué", "Filtre bouché"], solutionsPatient: ["Altitude OK ?", "Changer le filtre"], solutionsTech: ["Ajuster altitude", "Remplacer turbine", "Check Pression (P)"] },
          { title: "Fuites importantes", causes: ["Harnais lâche", "Bac mal inséré"], solutionsPatient: ["Resserrer", "Check bac"], solutionsTech: ["Remplacer joint"] },
          { title: "Bruit anormal ou vibrations", causes: ["Eau dans le tuyau"], solutionsPatient: ["Vider le tuyau"], solutionsTech: ["-"] },
          { title: "Carte SD illisible", causes: ["Formatage"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater"] },
          { title: "Alarme ou erreur système", causes: ["Bug logiciel"], solutionsPatient: ["Reset"], solutionsTech: ["-"] }
            ] },
          ...
          { title: "Fuites importantes", causes: ["Masque mal mis", "Coussin usé", "Harnais lâche", "Bac mal inséré"], solutionsPatient: ["Ajuster le masque", "Resserrer le harnais", "Check bac"], solutionsTech: ["Vérifier taille", "Remplacer joint"] },
          { title: "Pression insuffisante", causes: ["Filtre sale"], solutionsPatient: ["Changer le filtre"], solutionsTech: ["Calibration"] },
          { title: "Bruit anormal ou vibrations", causes: ["Moteur bruyant"], solutionsPatient: ["-"], solutionsTech: ["Changer moteur"] },
          { title: "Alarme ou erreur système", causes: ["Code erreur"], solutionsPatient: ["Noter le code"], solutionsTech: ["SAV"] },
          { title: "Carte SD illisible", causes: ["Formatage"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater"] }
            ] },
          ...
          { title: "Pression insuffisante ou instable", causes: ["Tuyau percé", "Masque débranché", "Filtre bouché", "Fuite circuit"], solutionsPatient: ["Tuyau bien enfoncé ?", "Check tuyau", "Changer filtre"], solutionsTech: ["Vérifier étanchéité", "Check turbine"] },
          { title: "Fuites importantes", causes: ["Ajustement masque", "HME (Filtre échangeur)"], solutionsPatient: ["Ajuster", "Changer le HME"], solutionsTech: ["-"] },
          { title: "Carte SD illisible", causes: ["Formatage"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater"] },
          { title: "Alarme ou erreur système", causes: ["Défaut électronique"], solutionsPatient: ["Reset"], solutionsTech: ["Logs"] }
            ] },
          ...
          { title: "Fuites importantes", causes: ["Sangles", "Bac mal inséré"], solutionsPatient: ["Resserrer les sangles", "Check insertion bac"], solutionsTech: ["Changer joint silicone"] },
          { title: "Pression insuffisante", causes: ["Moteur fatigué"], solutionsPatient: ["-"], solutionsTech: ["SAV technique"] },
          { title: "Bruit anormal ou vibrations", causes: ["Sifflement turbine"], solutionsPatient: ["-"], solutionsTech: ["Check moteur"] },
          { title: "Carte SD illisible", causes: ["Formatage"], solutionsPatient: ["Pousser la carte"], solutionsTech: ["Formater"] },
          { title: "Alarme ou erreur système", causes: ["Code d'erreur"], solutionsPatient: ["Reset"], solutionsTech: ["Logs technique"] }
            ] }
    ]
  },
  { 
    ...
    models: [
          { id: "prisma-cr", name: "Prisma CR", failures: [
              ...
              { title: "Fuites importantes", causes: ["Fuite masque", "Déconnexion", "Bac mal inséré"], solutionsPatient: ["Vérifier branchement", "Masque fuit ?", "Tuyau bien branché ?"], solutionsTech: ["Vérifier étanchéité circuit", "Vérifier joint bac"] },
          ...
          { id: "dreamstation-bipap-autosv", name: "DreamStation BiPAP autoSV", failures: [
              ...
              { title: "Fuites importantes", causes: ["Bac mal clipsé", "Joint usé"], solutionsPatient: ["Vérifier clipsage bac"], solutionsTech: ["Remplacer joint"] },
          ...
          { id: "bipap-autosv-advanced", name: "BiPAP autoSV Advanced", failures: [
              ...
              { title: "Fuites importantes", causes: ["Joint humidificateur", "Masque"], solutionsPatient: ["Vérifier masque"], solutionsTech: ["Remplacer embase"] },
          ...
          { id: "aircurve-10-cs", name: "AirCurve 10 CS PaceWave", failures: [
              ...
              { title: "Fuites importantes", causes: ["Bac mal inséré", "Joint abîmé", "Bac fendu"], solutionsPatient: ["Réservoir enfoncé à fond ?", "Joint propre et bien logé ?"], solutionsTech: ["Réinsérer bac", "Vérifier joint silicone", "Changer réservoir"] },
                ...
                id: "niv-i", name: "NIV I", brands: [
                    { id: "lowenstein", name: "Löwenstein", models: [
                        ...
                        { id: "prismaline", name: "prismaLine (Série WM100TD)", failures: [
                            ...
                            , { title: "Fuites importantes (Masque ou Circuit)", causes: ["Raccord mal serré", "Joint de sortie usé"], solutionsPatient: ["Sifflement audible ?", "Vérifier le branchement du tuyau"], solutionsTech: ["Check étanchéité interne", "Changer joint de sortie"] },
                            { title: "Bruit anormal ou vibrations", causes: ["Turbine fatiguée", "Filtre mal inséré"], solutionsPatient: ["Vérifier si le filtre gris est bien en place", "Appareil sur surface stable ?"], solutionsTech: ["Remplacer turbine", "Vérifier silentblocs"] },
                            { title: "Problème de batterie ou autonomie", causes: ["Batterie interne usée", "Stockage prolongé sans charge"], solutionsPatient: ["L'appareil bipe-t-il au branchement ?", "Laisser branché 24h"], solutionsTech: ["Remplacer accumulateur interne", "Vérifier circuit de charge"] },
                            { title: "Erreur Système (Code 701 / 703)", causes: ["Capteur de pression HS", "Bug électronique"], solutionsPatient: ["Redémarrer l'appareil", "Vérifier l'absence d'humidité"], solutionsTech: ["Remplacer capteur de pression", "Maintenance SAV"] }
                        ]},
                    ]},
                ...
                id: "niv-ii", name: "NIV II", brands: [
                    { id: "breas", name: "Breas", models: [
                        { id: "vivo-3", name: "Vivo 3", failures: [
                            ...
                            { title: "Défaut de synchronisation", causes: ["Trigger"], solutionsPatient: ["Lutte"], solutionsTech: ["Ajuster sensi"] },
                            { title: "Blocage de turbine", causes: ["Eau"], solutionsPatient: ["Bruit"], solutionsTech: ["Séchage"] },
                            { title: "Capteur de pression HS", causes: ["Défaut"], solutionsPatient: ["Erreur"], solutionsTech: ["Changer"] },
                            { title: "Alarme répétitive", causes: ["Fuite"], solutionsPatient: ["Ajuster masque"], solutionsTech: ["Vérifier seuils"] },
                            { title: "Problème d’humidification", causes: ["Réglage"], solutionsPatient: ["Nez sec"], solutionsTech: ["Check plaque"] },
                            { title: "Circuit endommagé", causes: ["Coupure"], solutionsPatient: ["Changer"], solutionsTech: ["-"] }
                        ]},
                        { id: "vivo-45", name: "Vivo 45", failures: [
                            ...
                            { title: "Alarme Déconnexion", causes: ["Débranchement du circuit", "Masque retiré", "Seuil d'alarme trop sensible"], solutionsPatient: ["Vérifier les raccords du tuyau", "S'assurer que le masque est bien en place"], solutionsTech: ["Vérifier la calibration du capteur de débit", "Ajuster les réglages d'alarme"] },
                            { title: "Alarme Volume Minute Bas ou Volume Courant Bas", causes: ["Encombrement bronchique", "Masque trop serré", "Changement physiologique"], solutionsPatient: ["Désencombrement (aspiration/toux)", "Desserrer légèrement le masque"], solutionsTech: ["Vérifier l'absence de fuite interne", "Recalibrer la turbine"] },
                            { title: "Bruit anormal ou vibrations", causes: ["Usure turbine", "Filtre mal mis"], solutionsPatient: ["Vérifier le filtre", "Placer sur surface stable"], solutionsTech: ["Changer turbine"] }
                        ]},
                    ]},
                    ...
                    { id: "philips", name: "Philips", models: [
                        { id: "bipap-a40", name: "BiPAP A40", failures: [
                            ...
                            { title: "Problème d'humidification (Air sec ou condensation)", causes: ["Connecteurs métalliques sales", "Plaque HS", "Désactivé dans le menu"], solutionsPatient: ["Nettoyer les contacts avec un coton-tige sec", "Assurez-vous que l'humidificateur est activé"], solutionsTech: ["Contrôler la résistance", "Remplacer la plaque."] },
                            { title: "Problème de batterie ou autonomie", causes: ["Batterie Smart défectueuse", "Fin de vie"], solutionsPatient: ["Vérifier l'enclenchement", "Laisser charger 4h"], solutionsTech: ["Tester la capacité réelle"] },
                            { title: "Erreur Système (Message d'erreur)", causes: ["Logiciel", "Carte"], solutionsPatient: ["Redémarrer l'appareil"], solutionsTech: ["Consulter le code erreur"] },
                            { title: "Alarme Circuit obstrué", causes: ["Tuyau plié", "Filtre HME saturé", "Obstruction air"], solutionsPatient: ["Dégager le tuyau", "Remplacer le filtre HME", "Nettoyer les filtres à air"], solutionsTech: ["Nettoyer bloc turbine", "Check capteur P"] },
                            { title: "Alarme Volume Minute Bas", causes: ["Fuite", "Encombrement"], solutionsPatient: ["Réajuster masque", "Désencombrement"], solutionsTech: ["Ajuster alarmes"] }
                        ]},
                    ]},
                    { id: "resmed", name: "ResMed", models: [
                        { id: "stellar-150", name: "Stellar 150", failures: [
                            { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Alimentation", "Batterie", "Carte"], solutionsPatient: ["Si vous le branchez sur le secteur, est-ce qu'il démarre ?", "Le voyant de charge est-il allumé ?"], solutionsTech: ["Tester l'alimentation.", "Remplacer la batterie.", "Remplacer la carte."] },
                            { title: "Pression insuffisante ou instable", causes: ["Fuite massive au masque", "Tuyau percé ou fissuré", "Filtre à air colmaté", "Usure turbine"], solutionsPatient: ["Est-ce que le masque est bien mis sur le visage ?", "Le filtre est-il propre ?", "Vérifiez que le tuyau n'est pas plié"], solutionsTech: ["Vérifier la calibration.", "Rechercher une fuite interne.", "Tester la turbine en mode service.", "Remplacer le bloc moteur."] },
                            { title: "Problème de batterie ou autonomie", causes: ["Batterie usée", "Stockage sans charge"], solutionsPatient: ["Laisser charger sur secteur 4h", "Vérifier le voyant arrière"], solutionsTech: ["Remplacer la batterie interne"] },
                            { title: "Erreur Système (Message d'erreur)", causes: ["Logiciel", "Carte"], solutionsPatient: ["Éteindre et rallumer"], solutionsTech: ["Consulter le code erreur"] },
                            { title: "Alarme Volume Minute Bas", causes: ["Fuite masque", "Encombrement"], solutionsPatient: ["Réajuster le masque", "Désencombrement"], solutionsTech: ["Check trigger/alarmes"] },
                            { title: "Alarme Pression Haute", causes: ["Circuit bouché", "Toux"], solutionsPatient: ["Vérifier tuyau non plié", "Changer filtre HME"], solutionsTech: ["Check valve expiratoire"] }
                        ]}
                    ]}
                ] 
            },
                ...
                id: "niv-iii", name: "NIV III", brands: [
                    ...
                    { id: "lowenstein", name: "Löwenstein", models: [
                        { id: "luisa", name: "Luisa", failures: [
                            ...
                            { title: "Problème d'oxygène (FiO2 basse)", causes: ["Source O2 vide ou fermée", "Cellule O2 usée ou non calibrée", "Fuite circuit"], solutionsPatient: ["Vérifier l'arrivée d'oxygène", "Recalibrer cellule O2 (Menu Maintenance)", "Vérifier raccords"], solutionsTech: ["Remplacer la cellule O2 (> 1 an)", "Tester la valve O2"] },
                            { title: "Problème d'affichage (Écran noir ou figé)", causes: ["Saleté/humidité sur écran", "Bug logiciel", "Nappe écran"], solutionsPatient: ["Nettoyer l'écran au sec", "Redémarrer l'appareil"], solutionsTech: ["Mise à jour firmware", "Changer bloc LCD", "Vérifier connectique"] }
                        ]}
                    ]},
                    { id: "philips", name: "Philips", models: [
                        { id: "trilogy-100", name: "Trilogy 100", failures: [
                            ...
                            { title: "Erreur Système (Message d'erreur)", causes: ["Logiciel", "Carte", "Évents de refroidissement obstrués", "Filtre mousse saturé"], solutionsPatient: ["Pouvez-vous l'éteindre complètement et le rallumer ?", "Dégager l'espace autour (> 15cm)", "Nettoyer/remplacer le filtre mousse"], solutionsTech: ["Consulter le code erreur.", "Vérifier le ventilateur interne", "Mise à jour firmware"] },
                            { title: "Volume Minute / Pression instable", causes: ["Déconnexion partielle", "Encombrement bronchique", "Fuite importante"], solutionsPatient: ["Vérifier tous les raccords", "Désencombrement (aspiration/kiné)", "Réajuster le masque"], solutionsTech: ["Vérifier calibration débit", "Check fuites internes", "Tester turbine"] },
                            { title: "Alarme Circuit déconnecté", causes: ["Circuit patient débranché", "Fuite massive"], solutionsPatient: ["Vérifier les connexions du tuyau", "Vérifier le masque", "Appuyer sur 'Silence alarme' et reconnecter"], solutionsTech: ["Tester avec un poumon de test", "Vérifier le capteur de pression"] },
                            ...
                            { title: "Fuites importantes (Déconnexion circuit)", causes: ["Débranchement circuit", "Sensibilité alarme trop basse", "Joint de sortie usé"], solutionsPatient: ["Inspecter la tubulure", "Vérifier les connecteurs du capteur de pression", "Ajuster le seuil d'alarme (si autorisé)"], solutionsTech: ["Vérifier la calibration du capteur de pression.", "Tester avec un autre circuit patient.", "Mise à jour du firmware."] }
                        ]},
                    ...
                    { id: "resmed", name: "ResMed", models: [
                        { id: "astral-150", name: "Astral 150", failures: [
                            ...
                            { title: "Erreur Système (Message d'erreur)", causes: ["Apprentissage circuit non réalisé", "Fuite valve expiratoire Astral", "Capteur O2 HS"], solutionsPatient: ["Lancer 'Apprentissage circuit'", "Vérifier le clipsage de la valve expiratoire"], solutionsTech: ["Tester avec un autre bloc valve", "Calibration des capteurs", "Remplacer cellule O2"] },
                            { title: "Alarme Volume Minute Bas (Vmin Bas)", causes: ["Encombrement bronchique", "Fuite importante au masque", "Pression inspiratoire insuffisante"], solutionsPatient: ["Réajuster le masque", "Pratiquer un désencombrement", "Vérifier si le tuyau est percé"], solutionsTech: ["Ajuster les alarmes", "Vérifier la calibration du capteur de débit"] },
                            { title: "Alarme Fréquence Haute", causes: ["Anxiété ou douleur", "Lutte contre la machine", "Auto-déclenchement (Trigger trop sensible)"], solutionsPatient: ["Se calmer et respirer avec la machine", "Vérifier l'absence de condensation dans le tuyau"], solutionsTech: ["Diminuer la sensibilité du trigger", "Vérifier les réglages de confort"] }
                        ]},
                        { id: "elisee-150", name: "Elisée 150", failures: [
                            { title: "Fuites importantes", causes: ["Tuyau de commande de la valve débranché ou percé", "Membrane valve percée ou mal positionnée"], solutionsPatient: ["Vérifier le petit tube fin qui longe le gros tuyau", "Remplacer la membrane en silicone de la valve expiratoire (petite pièce ronde transparente)"], solutionsTech: ["Vérifier pilotage valve", "Test étanchéité pneumatique"] },
                        ...
                        { id: "vs-iii", name: "VS III", failures: [
                            { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Cordon secteur déconnecté", "Bloc d'alimentation HS", "Fusible embase grillé"], solutionsPatient: ["Vérifier le branchement mural et sur l'appareil", "Le voyant du bloc secteur est-il allumé ?", "Tester sur une autre prise murale"], solutionsTech: ["Vérifier la tension de sortie du bloc (24V)", "Remplacer le fusible d'embase", "Contrôler l'interrupteur et la carte alim"] },
                            { title: "Pression insuffisante ou instable", causes: ["Circuit double branche mal connecté", "Fuite sur le port de pilotage", "Membrane valve expiratoire percée", "Capteur de pression HS"], solutionsPatient: ["Vérifier que le bloc arrière est bien clipsé", "Inspecter les raccords du circuit double", "Vérifier la membrane silicone"], solutionsTech: ["Vérifier l'étanchéité du bloc de pilotage interne.", "Recalibrer les capteurs de pression.", "Remplacer la membrane de la valve expiratoire."] },
                            { title: "Problème de batterie ou autonomie", causes: ["Batterie interne vieillissante", "Charge incomplète", "Défaut carte alimentation", "Surchauffe"], solutionsPatient: ["Laisser l'appareil branché en permanence", "Vérifier le voyant de charge", "Tester une another prise"], solutionsTech: ["Remplacer batterie interne.", "Vérifier le circuit de charge.", "Tester l'alimentation interne."] },
                            ...
                            { title: "Alarme Volume Minute Bas (Vmin Bas)", causes: ["Encombrement bronchique", "Fuite importante", "Pression insuffisante"], solutionsPatient: ["Pratiquer un désencombrement", "Réajuster le masque", "Vérifier l'absence de fuite"], solutionsTech: ["Ajuster les alarmes", "Vérifier la calibration du capteur de débit"] },
                            { title: "Alarme Pression Haute / Circuit obstrué", causes: ["Tuyau plié ou écrasé", "Filtre HME colmaté", "Encombrement patient"], solutionsPatient: ["Dégager le tuyau", "Remplacer le filtre antibactérien", "Réaliser une aspiration si nécessaire"], solutionsTech: ["Vérifier le capteur de pression", "Vérifier la valve expiratoire"] }
                        ]}
                    ]},
                    { id: "air-liquide", name: "Air Liquide", models: [
                        { id: "monnal-t50", name: "Monnal T50", failures: [
                            { title: "Erreur Système (Message d'erreur)", causes: ["Capteur débit humide/sale", "Batterie faible pour tests", "Branche mal insérée", "Obstruction turbine", "Poussière sur carte mère"], solutionsPatient: ["Vérifier propreté capteur", "Brancher sur secteur", "Vérifier l'étanchéité de la branche expiratoire"], solutionsTech: ["Calibrer le capteur de débit.", "Vérifier l'absence de condensation dans les tubulures.", "Dépoussiérage interne.", "Vérifier le ventilateur interne."] },
                            ...
                            { title: "Alarme O2 Bas", causes: ["Source O2 vide", "Cellule O2 usée", "Raccord O2 mal branché"], solutionsPatient: ["Vérifier la bouteille d'oxygène", "Vérifier le branchement au dos de la machine"], solutionsTech: ["Recalibrer la cellule O2", "Remplacer la cellule O2"] },
                         ...
                         {id: "eove-150", name: "EOVE 150", failures: [
                            ...
                            { title: "Pression insuffisante ou instable", causes: ["Masque", "Circuit", "Filtre"], solutionsPatient: ["Est-ce que le masque est bien mis sur le visage ?", "Le filtre est-il propre ?"], solutionsTech: ["Vérifier la calibration.", "Rechercher une fuite interne.", "Remplacer la turbine."] },
                            { title: "Erreur Système (Message d'erreur)", causes: ["Logiciel", "Carte"], solutionsPatient: ["Pouvez-vous l'éteindre complètement et le rallumer ?", "Quel est le message affiché ?"], solutionsTech: ["Consulter le code erreur.", "Remplacer la carte principale."] },
                            { title: "Problème de batterie ou autonomie", causes: ["Batterie interne usée", "Stockage"], solutionsPatient: ["Brancher sur secteur 12h", "Vérifier voyant"], solutionsTech: ["Remplacer batterie"] },
                            { title: "Problème d'oxygène (FiO2 basse)", causes: ["Source O2", "Cellule O2"], solutionsPatient: ["Vérifier O2", "Calibrer cellule"], solutionsTech: ["Changer cellule O2"] },
                            { title: "Échec Apprentissage Circuit", causes: ["Fuite", "Valve"], solutionsPatient: ["Vérifier raccords", "Membrane valve"], solutionsTech: ["Check capteurs"] }
                        ]},
                    { id: "puritan-bennett", name: "Puritan Bennett", models: [
                        { id: "pb-560", name: "PB 560", failures: [
                            { title: "Erreur Système (Message d'erreur)", causes: ["Paramètres incompatibles", "Erreur décharge totale", "Dysfonctionnement interne", "Capteur de pression décalibré", "Bug logiciel"], solutionsPatient: ["Revoir la prescription", "Valider chaque écran de réglage", "Éteindre et rallumer l'appareil", "Vérifier le type de circuit configuré"], solutionsTech: ["Réinitialiser l'appareil via le menu service.", "Mise à jour firmware.", "Changer le capteur de pression.", "Analyser les logs d'erreurs."] },
                            ...
                            { title: "Problème de trigger (Auto-déclenchement)", causes: ["Condensation dans le circuit", "Trigger trop sensible"], solutionsPatient: ["Vider l'eau du tuyau", "Réajuster le masque"], solutionsTech: ["Diminuer la sensibilité du trigger", "Vérifier l'étanchéité du circuit"] },
                    ...
                    { id: "saime", name: "Saime", models: [
                        { id: "eole-3", name: "Eole 3 S / XLS", failures: [
                            { title: "Problème d'alimentation (L'appareil ne démarre pas)", causes: ["Secteur déconnecté", "Fusible grillé", "Interrupteur HS"], solutionsPatient: ["Vérifier la prise", "Appuyer fort sur le bouton"], solutionsTech: ["Changer fusible embase", "Tester alim"] },
                            ...
                            { title: "Fuites importantes", causes: ["Valve expiratoire", "Circuit percé"], solutionsPatient: ["Vérifier branchement", "Serrer valve"], solutionsTech: ["Test étanchéité"] },
                            { title: "Bruit anormal", causes: ["Turbine usée"], solutionsPatient: ["Contacter tech"], solutionsTech: ["Changer bloc moteur"] },
                            { title: "Écran noir", causes: ["Nappe LCD", "Surtension"], solutionsPatient: ["Reset alim"], solutionsTech: ["Changer afficheur"] }
                        ]}
                    ]}
                ]
            } 
...
function performSearch(query) {
    ...
    LIBRARY_DATA.forEach(type => {
        const typeMatch = normalize(type.name).includes(lowerQuery);

        const processBrands = (brands, currentType, subT = null, subSubT = null, parentPath) => {
            if (!brands) return;
            brands.forEach(brand => {
                const brandPath = `${parentPath} > ${brand.name}`;
                const brandMatch = normalize(brand.name).includes(lowerQuery);
                if (brand && brand.models) {
                    brand.models.forEach(model => {
                        if (normalize(model.name).includes(lowerQuery) || typeMatch || brandMatch || (subT && normalize(subT.name).includes(lowerQuery)) || (subSubT && normalize(subSubT.name).includes(lowerQuery))) {
                            results.push({ type: currentType, subType: subT, subSubType: subSubT, brand: brand, model: model, path: `${brandPath} > ${model.name}` });
                        }
                    });
                }
            });
        ...
        const processSubTypes = (subTypes, currentType, parentPath) => {
            if (!subTypes) return;
            subTypes.forEach(subType => {
                const stPath = `${parentPath} > ${subType.name}`;
                const stMatch = normalize(subType.name).includes(lowerQuery);
                if (subType && subType.models) {
                    subType.models.forEach(model => {
                        if (normalize(model.name).includes(lowerQuery) || typeMatch || stMatch) {
                            results.push({ type: currentType, subType, subSubType: null, brand: null, model, path: `${stPath} > ${model.name}` });
                        }
                    });
                }
                if (subType.brands) processBrands(subType.brands, currentType, subType, null, stPath);
                if (subType.subTypes) subType.subTypes.forEach(subSubType => {
                    const sstPath = subSubType ? `${stPath} > ${subSubType.name}` : stPath;
                    const sstMatch = normalize(subSubType.name).includes(lowerQuery);
                    if (subSubType && subSubType.models) {
                        subSubType.models.forEach(model => {
                            if (normalize(model.name).includes(lowerQuery) || typeMatch || stMatch || sstMatch) {
                                results.push({ type: currentType, subType, subSubType, brand: null, model, path: `${sstPath} > ${model.name}` });
                            }
                        });
                    }
                    if (subSubType.brands) processBrands(subSubType.brands, currentType, subType, subSubType, sstPath);
                });
            });
        };
        ...
        if (type.models) {
            type.models.forEach(model => {
                if (normalize(model.name).includes(lowerQuery) || typeMatch) {
                    results.push({ type: type, subType: null, subSubType: null, brand: null, model: model, path: `${type.name} > ${model.name}` });
                }
            });
        }
        if (type.brands) processBrands(type.brands, type, null, null, type.name);
        if (type.subTypes) processSubTypes(type.subTypes, type, type.name);
    });
...
async function logIntervention(status) {
    ...
    const deviceName = state.type ? `${state.type.name}${state.brand ? ` (${state.brand.name})` : ''} > ${state.model?.name || ''}` : 'Inconnu';
    const entry = {
        id: Date.now(),
...
window.addItem = function() {
    ...
    } else if (state.type && !state.brand && (state.type.brands || ['vni', 'aspiration', 'vaa'].includes(state.type.id))) {
...
function render() {
    ...
    if (state.type) html += `<span>/</span><span class="breadcrumb-item ${state.subType || state.brand || state.model ? 'breadcrumb-active' : ''}" data-action="reset-to-type">${state.type.name}</span>`;
    if (state.subType) html += `<span>/</span><span class="breadcrumb-item ${state.subSubType || state.brand || state.model ? 'breadcrumb-active' : ''}" data-action="reset-to-sub-type">${state.subType.name}</span>`;
    if (state.subSubType) html += `<span>/</span><span class="breadcrumb-item ${state.brand || state.model ? 'breadcrumb-active' : ''}" data-action="reset-to-sub-sub-type">${state.subSubType.name}</span>`;
    ...
    if (state.view === 'history') {
        ...
        html += `<div style="display: flex; gap: 10px; margin-bottom: 20px;">
                    <button onclick="downloadHistoryExcel()" style="padding: 8px 16px; border-radius: 8px; border: 1px solid #0284c7; background: #0284c7; color: white; cursor: pointer; font-weight: 600;">📥 Télécharger Excel</button>
    ...
    else if (state.searchQuery && state.searchQuery.length > 1) {
